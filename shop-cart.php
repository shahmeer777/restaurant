...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/shop-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:13 GMT -->
<head>	
							...
							<li class="inline-block">
								...
								<ul class="dropdown-menu cart-list mt-2.5">
									...
									<li class="text-center d-flex">
										<a href="shop-cart.html" class="btn btn-primary mr-2 w-100 block btn-hover-1"><span>View Cart</span></a>
										<a href="our-menu-1.html" class="btn btn-outline w-100 block btn-hover-1"><span>Menu</span></a>
									</li>
								</ul>
							</li>
						</ul>
		...
		<div class="p-0 overflow-y-auto">
			...
			<div class="py-[60px] px-[70px]">
				<div class="login-head text-center">
					...
					<button name="submit" value="submit" type="submit" class="btn google-btn w-100 block">
    ...
    <section class="bg-[url('../images/banner/bnr4.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Shop Cart</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] font-normal pl-2 active">Shop Cart</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
            ...
            <div class="row">
                <div class="lg:w-2/3 w-full px-[15px]">
                    <div class="flex justify-between items-center">
                        <h5 class="lg:mb-[15px] mb-5">Related Products</h5>
                        ...
                        <div class="shop-filter style-1">
                            <div class="flex justify-between">
                                <div class="widget-title xl:mb-[30px] mb-5 pb-3 text-lg relative">
                                    <h5 class="">Cart <span class="text-primary">(03)</span></h5>
                                </div>
                            ...
                            <div class="cart-item flex items-center border-b border-[#2222221a] pb-[15px] mb-[15px]">
                                ...
                                <div class="dz-content ml-[15px] w-full">
                                    <div class="dz-head mb-[10px] flex items-center justify-between">
                                        <h6 class="text-base">Double Patty Burger</h6>
                                        <a href="javascript:void(0);" class="text-black2"><i class="fa-solid fa-xmark text-danger"></i></a>
                                    </div>
                            ...
                            <div class="cart-item flex items-center border-b border-[#2222221a] pb-[15px] mb-[15px]">
                                ...
                                <div class="dz-content ml-[15px] w-full">
                                    <div class="dz-head mb-[10px] flex items-center justify-between">
                                        <h6 class="text-base">All Combo</h6>
                                        <a href="javascript:void(0);" class="text-black2"><i class="fa-solid fa-xmark text-danger"></i></a>
                                    </div>
                                    <div class="dz-body flex items-center justify-between">
                                        <div class="input-group mt-[5px] flex flex-wrap items-stretch h-[31px] relative w-[105px] min-w-[105px]">
                            ...
                            <div class="cart-item flex items-center border-b border-[#2222221a] pb-[15px] mb-[15px]">
                                ...
                                <div class="dz-content ml-[15px] w-full">
                                    <div class="dz-head mb-[10px] flex items-center justify-between">
                                        <h6 class="text-base">Veg And crispy Burger</h6>
                                        <a href="javascript:void(0);" class="text-black2"><i class="fa-solid fa-xmark text-danger"></i></a>
                                    </div>
                                    <div class="dz-body flex items-center justify-between">
                                        <div class="input-group mt-[5px] flex flex-wrap items-stretch h-[31px] relative w-[105px] min-w-[105px]">
                            ...
                            <div class="order-detail mt-10">
                                ...
                                <table class="mb-[25px] w-full border-collapse">
                                    <tbody>
                                        <tr>
                                            <td class="py-[6px] font-medium text-sm leading-[21px] text-bodycolor">Item Total</td>
                                            <td class="price text-primary font-semibold text-base leading-6 text-right">$55.00</td>
                                        </tr>
                                        <tr class="charges border-b border-dashed border-[#22222233]">
                                            <td class="pt-[6px] pb-[15px] font-medium text-sm leading-[21px] text-bodycolor">Delivery Charges</td>
                                            <td class="price pt-[6px] pb-[15px] text-primary font-semibold text-base leading-6 text-right">$5.00</td>
                                        </tr>
                                        <tr class="tax border-b-2 border-[#22222233]">
                                            <td class="pt-[6px] pb-[15px] font-medium text-sm leading-[21px] text-bodycolor">Govt Taxes & Other Charges</td>
                                            <td class="price pt-[6px] pb-[15px] text-primary font-semibold text-base leading-6 text-right">$3.50</td>
                                        </tr>
                                        <tr class="total">
                                            <td class="py-[6px] font-medium text-sm leading-[21px] text-bodycolor"><h6>Total</h6></td>
                                            <td class="price text-primary font-semibold text-base leading-6 text-right">$63.50</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <a href="shop-checkout.html" class="btn btn-primary block text-center btn-md w-full btn-hover-1"><span class="z-[2] relative block">Order Now <i class="fa-solid fa-arrow-right ml-[10px]"></i></span></a>
                            </div>
                        </div>
                    </aside>
                </div>
