...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/our-menu-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:40 GMT -->
<head>	
...
<body id="bg" class="box-border m-0 selection:bg-primary selection:text-white font-poppins">
    ...
    <!-- Banner  -->
    <section class="bg-[url('../images/banner/bnr5.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Our Menu 5</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] font-normal pl-2 active">Our Menu 5</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
			...
			<div class="container">
				...
				<div class="clearfix" id="lightgallery">
					<ul id="masonry" class="row dlab-gallery-listing gallery">
						<li class="card-container lg:w-1/4 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All pizza spicy">
						...
						<li class="card-container lg:w-1/4 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All salad burger">
							<div class="group rounded-lg menu-box box-hover text-center pt-10 px-5 pb-[30px] bg-white border border-grey-border hover:border-primary h-full flex duration-500 flex-col relative overflow-hidden z-[1] active">
								<div class="w-[150px] min-w-[150px] h-[150px] mt-0 mx-auto mb-[10px] rounded-full border-[9px] border-white duration-500 z-[1]">
						...
						<li class="card-container lg:w-1/4 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All drink sweet">
							<div class="group rounded-lg menu-box box-hover text-center pt-10 px-5 pb-[30px] bg-white border border-grey-border hover:border-primary h-full flex duration-500 flex-col relative overflow-hidden z-[1] active">
								<div class="w-[150px] min-w-[150px] h-[150px] mt-0 mx-auto mb-[10px] rounded-full border-[9px] border-white duration-500 z-[1]">
						...
						<li class="card-container lg:w-1/4 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All pizza burger">
						...
						<li class="card-container lg:w-1/4 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All drink spicy">
                            <div class="group rounded-lg menu-box box-hover text-center pt-10 px-5 pb-[30px] bg-white border border-grey-border hover:border-primary h-full flex duration-500 flex-col relative overflow-hidden z-[1]">
                                <div class="w-[150px] min-w-[150px] h-[150px] mt-0 mx-auto mb-[10px] rounded-full border-[9px] border-white duration-500 z-[1]">
						...
						<li class="card-container lg:w-1/4 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All drink salad">
                            <div class="group rounded-lg menu-box box-hover text-center pt-10 px-5 pb-[30px] bg-white border border-grey-border hover:border-primary h-full flex duration-500 flex-col relative overflow-hidden z-[1]">
                                <div class="w-[150px] min-w-[150px] h-[150px] mt-0 mx-auto mb-[10px] rounded-full border-[9px] border-white duration-500 z-[1]">
                                    <img src="assets/images/gallery/small/pic8.jpg" alt="" class="rounded-full group-hover:animate-spin">
                                </div>
                                <div class="mt-auto">
                                    <h4 class="mb-2.5">
                                        <a href="product-detail.html">
                                    ...
                                    <p class="mb-2">Lorem ipsum dolor sit amet consectetur adipiscing.</p>
                                    <h5 class="text-primary">$30.00</h5>
                                    <a href="shop-cart.html" class="btn btn-primary mt-[18px] btn-hover-2">Add To Cart</a>
                                </div>
					        </div>
						</li>
						<li class="card-container lg:w-1/4 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All drink burger">
                            <div class="group rounded-lg menu-box box-hover text-center pt-10 px-5 pb-[30px] bg-white border border-grey-border hover:border-primary h-full flex duration-500 flex-col relative overflow-hidden z-[1]">
                                <div class="w-[150px] min-w-[150px] h-[150px] mt-0 mx-auto mb-[10px] rounded-full border-[9px] border-white duration-500 z-[1]">
						...
						<li class="card-container lg:w-1/4 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All sweet spicy">
                            <div class="group rounded-lg menu-box box-hover text-center pt-10 px-5 pb-[30px] bg-white border border-grey-border hover:border-primary h-full flex duration-500 flex-col relative overflow-hidden z-[1]">
                                <div class="w-[150px] min-w-[150px] h-[150px] mt-0 mx-auto mb-[10px] rounded-full border-[9px] border-white duration-500 z-[1]">
                                    <img src="assets/images/gallery/small/pic10.jpg" alt="" class="rounded-full group-hover:animate-spin">
                                </div>
                                <div class="mt-auto">
                                    <h4 class="mb-2.5">
                                        <a href="product-detail.html">
                                    ...
                                    <p class="mb-2">Lorem ipsum dolor sit amet consectetur adipiscing.</p>
                                    <h5 class="text-primary">$90.00</h5>
                                    <a href="shop-cart.html" class="btn btn-primary mt-[18px] btn-hover-2">Add To Cart</a>
                                </div>
					        </div>
						</li>
						<li class="card-container lg:w-1/4 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All pizza burger">
                            <div class="group rounded-lg menu-box box-hover text-center pt-10 px-5 pb-[30px] bg-white border border-grey-border hover:border-primary h-full flex duration-500 flex-col relative overflow-hidden z-[1]">
                                <div class="w-[150px] min-w-[150px] h-[150px] mt-0 mx-auto mb-[10px] rounded-full border-[9px] border-white duration-500 z-[1]">
                                    <img src="assets/images/gallery/small/pic11.jpg" alt="" class="rounded-full group-hover:animate-spin">
                                </div>
                                <div class="mt-auto">
                                    <h4 class="mb-2.5">
                                        <a href="product-detail.html">
                                    ...
                                    <p class="mb-2">Lorem ipsum dolor sit amet consectetur adipiscing.</p>
                                    <h5 class="text-primary">$28.00</h5>
                                    <a href="shop-cart.html" class="btn btn-primary mt-[18px] btn-hover-2">Add To Cart</a>
                                </div>
					        </div>
						</li>
						<li class="card-container lg:w-1/4 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All drink sweet spicy">
                            <div class="group rounded-lg menu-box box-hover text-center pt-10 px-5 pb-[30px] bg-white border border-grey-border hover:border-primary h-full flex duration-500 flex-col relative overflow-hidden z-[1]">
                                <div class="w-[150px] min-w-[150px] h-[150px] mt-0 mx-auto mb-[10px] rounded-full border-[9px] border-white duration-500 z-[1]">
                                    <img src="assets/images/gallery/small/pic12.jpg" alt="" class="rounded-full group-hover:animate-spin">
                                </div>
                                <div class="mt-auto">
                                    <h4 class="mb-2.5">
                                        <a href="product-detail.html">
                                    ...
                                    <p class="mb-2">Lorem ipsum dolor sit amet consectetur adipiscing.</p>
                                    <h5 class="text-primary">$40.00</h5>
                                    <a href="shop-cart.html" class="btn btn-primary mt-[18px] btn-hover-2">Add To Cart</a>
                                </div>
					        </div>
						</li>
...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/our-menu-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:41 GMT -->
</html>