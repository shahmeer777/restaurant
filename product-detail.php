...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:09 GMT -->
<head>	
...
<body id="bg" class="box-border m-0 selection:bg-primary selection:text-white font-poppins">
    ...
    <section class="bg-[url('../images/banner/bnr1.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Product Detail</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] font-normal pl-2 active">Product Detail</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
				...
				<div class="row product-detail">
					...
					<div class="lg:w-8/12 md:w-7/12 w-full px-[15px]">
						<div class="detail-info relative">
                            <span class="badge mb-[10px] p-[2px] font-medium text-sm leading-5 text-[#666666] flex items-center rounded-[10px]">
                            ...
                            <div class="dz-head">
                                <h2 class="mb-2 lg:text-4xl sm:text-[2rem] text-[1.75rem] font-semibold">Double Patty Veg Burger</h2>
                            ...
                            <p class="text-[15px] mt-5 mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                            <ul class="detail-list flex my-[25px]">
                                ...
                                <li class="mr-[45px] text-[15px] font-medium leading-[22px] text-bodycolor">Quantity
                                    <div class="input-group mt-[5px] flex flex-wrap items-stretch h-[31px] relative w-[105px] min-w-[105px]">
                            ...
                            <ul class="add-product flex flex-wrap mx-[-5px] mb-[30px] w-full">
                                <li class="p-[5px] sm:w-[50%] w-full"><div class="mini-modal inline-flex p-[10px] w-full rounded-[10px] items-center border border-[#2222221a]">
                            ...
                            <div class="lg:flex justify-between">
                                <ul class="modal-btn-group sm:flex block mx-[-7px]">
                                    <li class="mx-[7px] lg:mb-0 mb-[10px]">
										<a href="shop-cart.html" class="btn shadow-none btn-primary btn-hover-1">
											<span>Add To Cart <i class="flaticon-shopping-bag-1 text-xl ml-[10px] inline-flex"></i>
											</span>
										</a>
									</li>
                                    <li class="mx-[7px] lg:mb-0 mb-[10px]">
										<a href="shop-checkout.html" class="btn shadow-none btn-outline-secondary btn-hover-1 text-yellow">
                                ...
                                <ul class="avatar-list avatar-list-stacked flex">
                                    <li class="avatar inline-block relative duration-300 hover:z-[1] mr-[-17px]"><img src="assets/images/testimonial/small/pic1.jpg" alt="" class="object-cover rounded-full h-[2.735rem] w-[2.735rem] border-2 border-white"></li>
                                    <li class="avatar inline-block relative duration-300 hover:z-[1] mr-[-17px]"><img src="assets/images/testimonial/small/pic2.jpg" alt="" class="object-cover rounded-full h-[2.735rem] w-[2.735rem] border-2 border-white"></li>
                                    <li class="avatar inline-block relative duration-300 hover:z-[1] mr-[-17px]"><img src="assets/images/testimonial/small/pic3.jpg" alt="" class="object-cover rounded-full h-[2.735rem] w-[2.735rem] border-2 border-white"></li>
                                    <li class="avatar inline-block relative duration-300 hover:z-[1] mr-[-17px]"><img src="assets/images/testimonial/small/pic4.jpg" alt="" class="object-cover rounded-full h-[2.735rem] w-[2.735rem] border-2 border-white"></li>
                                    <li class="avatar inline-block relative duration-300 hover:z-[1] mr-[-17px]"><img src="assets/images/testimonial/small/pic5.jpg" alt="" class="object-cover rounded-full h-[2.735rem] w-[2.735rem] border-2 border-white"></li>
                                    <li class="avatar inline-block relative duration-300 hover:z-[1]"><span class="bg-primary h-[2.735rem] w-[2.735rem] leading-[2.735rem] text-center inline-block text-xs rounded-full text-white">150+</span></li>
                                </ul>
                            </div>
                        </div>
					</div>
					...
					<div class="w-full px-[15px]">
						<ul class="nav nav-tabs tabs-style-1 flex flex-wrap mb-[30px] border-b-2 border-[#EAEAEA]">
							<li class="nav-item mr-[3px] mb-[-1px] rounded-ss-md rounded-se-md overflow-hidden">
								<button class="nav-link border-2 border-transparent px-4 py-2 block active web-design-1" href="#web-design-1">
									<i class="icon-globe"></i>
									<span class="hidden md:inline-block ml-[10px]">Description</span>
								</button>
							</li>
							<li class="nav-item mr-[3px] mb-[-1px] rounded-ss-md rounded-se-md overflow-hidden">
								<button class="nav-link border-2 border-transparent px-4 py-2 block graphic-design-1" href="#graphic-design-1">
									<i class="icon-image"></i>
									<span class="hidden md:inline-block ml-[10px]">Additional Information</span>
								</button>
							</li>
							<li class="nav-item mr-[3px] mb-[-1px] rounded-ss-md rounded-se-md overflow-hidden">
								<button class="nav-link border-2 border-transparent px-4 py-2 block developement-1" href="#developement-1">
						...
						<div class="tab-content">
							<div id="web-design-1" class="tab-pane duration-500 active">
								<p class="mb-[10px] lg:text-base text-[15px]">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't hidden in the middle of text.</p>
								...
								<ul class="list-check primary">
									<li class="relative lg:text-base text-[15px] py-[6px] pr-[5px] pl-[30px] text-bodycolor">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and </li>
									<li class="relative lg:text-base text-[15px] py-[6px] pr-[5px] pl-[30px] text-bodycolor">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </li>
								</ul>
							</div>
							<div id="graphic-design-1" class="tab-pane duration-500" style="display: none;">
								<table class="mb-5 border border-[#00000020] align-middle w-full">
									<tr>
										<td class="p-[15px] font-medium text-bodycolor border border-[#00000020] ">Cheese Burger</td>
										<td class="p-[15px] font-medium text-bodycolor border border-[#00000020] ">Small, Medium & Large</td>
									</tr>
									<tr>
										<td class="p-[15px] font-medium text-bodycolor border border-[#00000020] ">Toppings</td>
										<td class="p-[15px] font-medium text-bodycolor border border-[#00000020] ">Onion, Tomato, Olives</td>
									</tr>
									<tr>
										<td class="p-[15px] font-medium text-bodycolor border border-[#00000020] ">Rating</td>
									...
									<tr>
										<td class="p-[15px] font-medium text-bodycolor border border-[#00000020] ">Shipping Charges</td>
										<td class="p-[15px] font-medium text-bodycolor border border-[#00000020] ">Free Shipping</td>
									</tr>
									<tr>
										<td class="p-[15px] font-medium text-bodycolor border border-[#00000020] ">Add More</td>
										<td class="p-[15px] font-medium text-bodycolor border border-[#00000020] ">Coke, Cheese, Choco lava</td>
									</tr>
									<tr>
										<td class="p-[15px] font-medium text-bodycolor border border-[#00000020] ">Delivery Time</td>
										<td class="p-[15px] font-medium text-bodycolor border border-[#00000020] ">30 mins</td>
									</tr>
								</table>
							</div>		
							<div id="developement-1" class="tab-pane duration-500" style="display: none;">
								<div class="comments-area" id="comments">
									<ul class="comment-list md:mb-[60px] mb-10">
										<li class="comment">
											<div class="comment-body relative min-h-[95px] border-b border-[#2222221a] md:pl-[100px] pl-[75px] md:pb-[30px] pb-[15px] md:mb-[30px] mb-5">
												<div class="comment-author vcard"> 
													<img  class="md:h-[80px] h-[60px] md:w-[80px] w-[60px] rounded-full left-0 absolute" src="assets/images/testimonial/mini/pic1.jpg" alt="/"> 
													<cite class="not-italic text-base font-semibold mb-2 block">Monsur Rahman Lito</cite>
												</div>
										...
										<li class="comment">
											<div class="comment-body relative min-h-[95px] border-b border-[#2222221a] md:pl-[100px] pl-[75px] md:pb-[30px] pb-[15px] md:mb-[30px] mb-5">
												<div class="comment-author vcard"> 
													<img  class="md:h-[80px] h-[60px] md:w-[80px] w-[60px] rounded-full left-0 absolute" src="assets/images/testimonial/mini/pic2.jpg" alt="/"> 
													<cite class="not-italic text-base font-semibold mb-2 block">Jake Johnson</cite>
												</div>
												<div class="star-rating mb-[10px] text-sm" data-rating="3">
													<i class="fas fa-star text-yellow"></i> 
													<i class="fas fa-star text-yellow"></i> 
													<i class="fas fa-star text-yellow"></i> 
													<i class="far fa-star text-yellow"></i> 
										...
										<li class="comment">
											<div class="comment-body relative min-h-[95px] border-b border-[#2222221a] md:pl-[100px] pl-[75px] md:pb-[30px] pb-[15px] md:mb-[30px] mb-5">
												<div class="comment-author vcard"> 
													<img  class="md:h-[80px] h-[60px] md:w-[80px] w-[60px] rounded-full left-0 absolute" src="assets/images/testimonial/mini/pic3.jpg" alt="/"> 
													<cite class="not-italic text-base font-semibold mb-2 block">John Doe</cite> 
												</div>
												<div class="star-rating mb-[10px] text-sm" data-rating="4">
													<i class="fas fa-star text-yellow"></i> 
													<i class="fas fa-star text-yellow"></i> 
													<i class="fas fa-star text-yellow"></i> 
													<i class="fas fa-star text-yellow"></i> 
								...
								<div class="comment-respond style-1" id="respond">
									<h3 class="widget-title xl:mb-[30px] mb-5 pb-3 relative text-2xl" id="reply-title">Add a review</h3>
									<form class="flex flex-wrap mx-[-10px]" id="commentform" method="post">
										<p class="mb-[30px] px-[10px] sm:w-[50%] w-full comment-form-author">
											...
											<input type="text" class="h-[60px] py-[15px] bg-[#f3f4f6] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] border-2 border-[#f3f4f6] focus:border-primary focus:bg-white duration-500" name="dzName"  placeholder="Author" id="author">
										</p>
										<p class="mb-[30px] px-[10px] sm:w-[50%] w-full comment-form-email">
											...
											<input type="text" class="h-[60px] py-[15px] bg-[#f3f4f6] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] border-2 border-[#f3f4f6] focus:border-primary focus:bg-white duration-500" placeholder="Email" name="dzEmail" id="email">
										</p>
										<div class="comment-form-rating flex text-bodycolor px-[10px]">
											...
											<div class="rating-widget">
												...
												<div  class="rating-stars">
													<ul id="stars">
														<li class="star inline-block" title="Poor" data-value="1">
															<i class="fas fa-star fa-fw text-sm text-[#ccc]"></i>
														</li>
														<li class="star inline-block" title="Fair" data-value="2">
															<i class="fas fa-star fa-fw text-sm text-[#ccc]"></i>
														</li>
														<li class="star inline-block" title="Good" data-value="3">
															<i class="fas fa-star fa-fw text-sm text-[#ccc]"></i>
														</li>
														<li class="star inline-block" title="Excellent" data-value="4">
															<i class="fas fa-star fa-fw text-sm text-[#ccc]"></i>
														</li>
														<li class="star inline-block" title="WOW!!!" data-value="5">
															<i class="fas fa-star fa-fw text-sm text-[#ccc]"></i>
														</li>
													</ul>
												</div>
										...
										<p class="comment-form-comment mb-5 px-[10px] w-full">
											...
											<textarea rows="10" name="comment" placeholder="Type Review Here" id="comment" class="resize-none h-[120px] py-[15px] bg-[#f3f4f6] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] border-2 border-[#f3f4f6] focus:border-primary focus:bg-white duration-500"></textarea>
										</p>
		...
		<section class="pt-0 lg:pb-[100px] pb-[70px] relative bg-white overflow-hidden">
			<div class="container">			
				<div class="mb-[50px] max-xl:mb-[30px] relative mx-auto text-center">
                    <h2 class="font-lobster">Special Menu</h2>
                </div>
	...
	<script src="assets/js/jquery.star-rating-svg.js"></script> <!-- Star rating JS -->
...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:13 GMT -->
</html>