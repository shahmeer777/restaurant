...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/our-menu-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:13 GMT -->
<head>	
    ...
    <section class="bg-[url('../images/banner/bnr1.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Our Menu 1</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] font-normal active pl-2">Our Menu 1</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
    ...
    <section class="lg:pt-[100px] sm:pt-[70px] pt-[50px] lg:pb-[70px] sm:pb-10 pb-5 section-wrapper-7 overflow-hidden relative bg-white">
        <div class="container">
            <div class="row inner-section-wrapper md:mb-[50px]">
                <div class="xl:w-1/3 md:w-1/2 w-full px-[15px]">
                    <div class="menu-head mb-[25px]">
                        <h4 class="title font-lobster text-[34px] font-normal text-primary">Starters</h4>
                    </div>
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Creamy Mushroom Soup</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$10</span>
                            </div>     
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Stuffed Mushrooms</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$14</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Grilled Caesar Salad</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$18</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Signature Autumn Salad</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$25</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Glazed Tomato Bruschite</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$35</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                ...
                <div class="xl:w-1/3 md:w-1/2 w-full px-[15px]">
                    <div class="menu-head mb-[25px]">
                        <h4 class="title font-lobster text-[34px] font-normal text-primary">Seafood</h4>
                    </div>
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Baked Oysters Rockefeller</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$13</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Grilled Shrimp Skewers</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$15</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Seafood Linguine</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$14</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Shrimp Scampi</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$20</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
            ...
            <div class="row">
                <div class="xl:w-1/3 md:w-1/2 w-full px-[15px]">
                    <div class="menu-head mb-[25px]">
                        <h4 class="title font-lobster text-[34px] font-normal text-primary">Drinks</h4>
                    </div>
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Cranberry Juice</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$23</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Hot Chocolate</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$99</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Lemon-Lime Soda</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$24</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Alcoholic beverages</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$10</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                ...
                <div class="xl:w-1/3 md:w-1/2 w-full px-[15px]">
                    <div class="menu-head mb-[25px]">
                        <h4 class="title font-lobster text-[34px] font-normal text-primary">Specials</h4>
                    </div>
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Beef Tenderloin & Red Wine</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$60</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Mushroom Risotto</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$55</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Lobster Thermidor</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$21</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Beef Bourguignon</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$15</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                ...
                <div class="xl:w-1/3 md:w-1/2 w-full px-[15px]">
                    <div class="menu-head mb-[25px]">
                        <h4 class="title font-lobster text-[34px] font-normal text-primary">Meat</h4>
                    </div>
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Beef Bourguignon</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$30</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Barbecue Ribs</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$28</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Roasted Turkey</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$40</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
                    ...
                    <div class="dz-shop-card style-2 relative overflow-hidden mb-[30px] p-0 shadow-none">
                        <div class="dz-content flex flex-col w-full">
                            <div class="dz-headdz-head flex justify-between items-center mb-3">
                                <span class="header-text lg:text-lg text-base lg:leading-7 lg:leading-528px]a font-semibold"><a href="shop-style-2.html" class="text-black2 max-w-[280px] text-ellipsis overflow-hidden block whitespace-nowrap duration-500 hover:text-primary">Beef Stroganoff</a></span>
                                <span class="img-line block"></span>
                                <span class="header-price header-price text-primary font-semibold text-xl leading-7">$92</span>
                            </div>
                            <p class="dz-body dz-body text-[15px] text-bodycolor leading-[21px] font-normal">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            </p>
        ...
        <img class="bg1 animate-move absolute top-[85px] left-[-110px] max-2xl:hidden" src="assets/images/background/pic12.png" alt="/">
        <img class="bg2 animate-move absolute right-[-54px] top-[30px] max-2lg:top-auto max-2lg:bottom-0 z-[0] 2xl:w-[600px] md:w-[500px] md:block hidden" src="assets/images/background/pic14.png" alt="/">
    </section>
    <!-- Our Menu-->	
...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/our-menu-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:14 GMT -->
</html>