...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:53 GMT -->
<head>	
...
<body id="bg" class="box-border m-0 selection:bg-primary selection:text-white font-poppins">
    ...
    <!-- Banner  -->
    <section class="bg-[url('../images/banner/bnr1.jpg')] bg-fixed  relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] overflow-hidden lg:h-[450px] md:h-[400px] h-[320px] bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Contact Us</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] pl-2 font-normal active">Contact Us</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
    ...
    <!-- Contact Section -->
		<section class="section-wrapper-8 sm:pt-[100px] pt-[50px] lg:pb-[100px] sm:pb-10 pb-5 md:px-[30px] px-[15px] 2xl:mx-[100px] lg:mx-[50px] bg-[#2222220a] rounded-[30px] 2xl:mb-[100px] lg:mb-[70px] 2xl:mt-[270px] lg:mt-[190px]">
			<div class="container">
				<div class="row inner-section-wrapper items-center 2xl:mb-[80px] lg:mb-[60px] md:mb-[30px] mb-[45px] 2xl:mt-[-215px] lg:mt-[-170px] mt-0">
					<div class="lg:w-1/4 sm:w-1/2 w-full px-[15px]">
						<div class="icon-bx-wraper relative mb-[30px] xl:pb-[60px] lg:pb-[45px] lg:pt-0 lg:px-0 py-[30px] px-5 lg:rounded-none rounded-[10px] lg:shadow-none shadow-[0px_15px_55px_rgba(34,34,34,0.15)] lg:z-auto z-[1] text-center duration-500 style-5 hover-aware box-hover lg:overflow-visible overflow-hidden group">
							<div class="icon-bx xl:w-[115px] lg:w-[90px] w-[60px] xl:h-[115px] lg:h-[90px] h-[60px] xl:leading-[115px] lg:leading-[90px] leading-[60px] lg:absolute mx-auto lg:mb-0 mb-[15px] lg:translate-x-[-50%] lg:translate-y-[-50%] left-[50%] z-[2] text-center group-hover:bg-transparent"> 
								<div class="icon-cell lg:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] lg:bg-white rounded-full">
									<i class="flaticon-placeholder lg:text-[50px] lg:leading-[50px] text-[45px] leading-[45px] text-primary lg:group-hover:text-primary group-hover:text-white "></i>
								</div>
							</div>
							<div class="icon-content xl:pt-[90px] lg:pt-[65px] xl:px-10 lg:px-5 lg:pb-[30px] lg:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] lg:rounded-[10px] lg:bg-white lg:relative lg:overflow-hidden z-[1] group-hover:text-white">
								<h5 class="mb-[10px]">Location</h5>
								<p class="text-base max-2lg:text-sm max-xl:break-words mb-4 leading-[1.5] group-hover:text-white">6952 Shelley St <br>Melbource</p>
								<div class="effect absolute block rounded-[50%] z-[-1] translate-x-[-50%] translate-y-[-50%] bg-primary w-0 h-0 duration-500 group-hover:w-[300%] group-hover:h-[300%]"></div>
							</div>
						</div>
					</div>
					<div class="lg:w-1/4 sm:w-1/2 w-full px-[15px]">
						<div class="icon-bx-wraper relative mb-[30px] xl:pb-[60px] lg:pb-[45px] lg:pt-0 lg:px-0 py-[30px] px-5 lg:rounded-none rounded-[10px] lg:shadow-none shadow-[0px_15px_55px_rgba(34,34,34,0.15)] lg:z-auto z-[1] text-center duration-500 style-5 hover-aware box-hover lg:overflow-visible overflow-hidden group">
							<div class="icon-bx xl:w-[115px] lg:w-[90px] w-[60px] xl:h-[115px] lg:h-[90px] h-[60px] xl:leading-[115px] lg:leading-[90px] leading-[60px] lg:absolute mx-auto lg:mb-0 mb-[15px] lg:translate-x-[-50%] lg:translate-y-[-50%] left-[50%] z-[2] text-center group-hover:bg-transparent"> 
								<div class="icon-cell lg:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] lg:bg-white rounded-full">
									<i class="flaticon-telephone lg:text-[50px] lg:leading-[50px] text-[45px] leading-[45px] text-primary lg:group-hover:text-primary group-hover:text-white "></i>
								</div>
							</div>
							<div class="icon-content xl:pt-[90px] lg:pt-[65px] xl:px-10 lg:px-5 lg:pb-[30px] lg:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] lg:rounded-[10px] lg:bg-white lg:relative lg:overflow-hidden z-[1] group-hover:text-white">
								<h5 class="mb-[10px]">Phone Number</h5>
								<p class="text-base max-2lg:text-sm max-xl:break-words mb-4 leading-[1.5] group-hover:text-white">+(800) 800-900-100 <br>+222 33 567 8665</p>
								<div class="effect absolute block rounded-[50%] z-[-1] translate-x-[-50%] translate-y-[-50%] bg-primary w-0 h-0 duration-500 group-hover:w-[300%] group-hover:h-[300%]"></div>
							</div>
						</div>
					</div>
					<div class="lg:w-1/4 sm:w-1/2 w-full px-[15px]">
						<div class="icon-bx-wraper relative mb-[30px] xl:pb-[60px] lg:pb-[45px] lg:pt-0 lg:px-0 py-[30px] px-5 lg:rounded-none rounded-[10px] lg:shadow-none shadow-[0px_15px_55px_rgba(34,34,34,0.15)] lg:z-auto z-[1] text-center duration-500 style-5 hover-aware box-hover lg:overflow-visible overflow-hidden group">
							<div class="icon-bx xl:w-[115px] lg:w-[90px] w-[60px] xl:h-[115px] lg:h-[90px] h-[60px] xl:leading-[115px] lg:leading-[90px] leading-[60px] lg:absolute mx-auto lg:mb-0 mb-[15px] lg:translate-x-[-50%] lg:translate-y-[-50%] left-[50%] z-[2] text-center group-hover:bg-transparent"> 
								<div class="icon-cell lg:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] lg:bg-white rounded-full">
									<i class="flaticon-email-1 lg:text-[50px] lg:leading-[50px] text-[45px] leading-[45px] text-primary lg:group-hover:text-primary group-hover:text-white "></i>
								</div>
							</div>
							<div class="icon-content xl:pt-[90px] lg:pt-[65px] xl:px-10 lg:px-5 lg:pb-[30px] lg:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] lg:rounded-[10px] lg:bg-white lg:relative lg:overflow-hidden z-[1] group-hover:text-white">
								<h5 class="mb-[10px]">Email Address</h5>
								<p class="text-base max-2lg:text-sm max-xl:break-words mb-4 leading-[1.5] group-hover:text-white">Info@Webmail.com <br>Info@Example.web.com</p>
								<div class="effect absolute block rounded-[50%] z-[-1] translate-x-[-50%] translate-y-[-50%] bg-primary w-0 h-0 duration-500 group-hover:w-[300%] group-hover:h-[300%]"></div>
							</div>
						</div>
					</div>
					<div class="lg:w-1/4 sm:w-1/2 w-full px-[15px]">
						<div class="icon-bx-wraper relative mb-[30px] xl:pb-[60px] lg:pb-[45px] lg:pt-0 lg:px-0 py-[30px] px-5 lg:rounded-none rounded-[10px] lg:shadow-none shadow-[0px_15px_55px_rgba(34,34,34,0.15)] lg:z-auto z-[1] text-center duration-500 style-5 hover-aware box-hover lg:overflow-visible overflow-hidden group">
							<div class="icon-bx xl:w-[115px] lg:w-[90px] w-[60px] xl:h-[115px] lg:h-[90px] h-[60px] xl:leading-[115px] lg:leading-[90px] leading-[60px] lg:absolute mx-auto lg:mb-0 mb-[15px] lg:translate-x-[-50%] lg:translate-y-[-50%] left-[50%] z-[2] text-center group-hover:bg-transparent"> 
								<div class="icon-cell lg:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] lg:bg-white rounded-full">
									<i class="flaticon-clock-1 lg:text-[50px] lg:leading-[50px] text-[45px] leading-[45px] text-primary lg:group-hover:text-primary group-hover:text-white "></i>
								</div>
							</div>
							<div class="icon-content xl:pt-[90px] lg:pt-[65px] xl:px-10 lg:px-5 lg:pb-[30px] lg:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] lg:rounded-[10px] lg:bg-white lg:relative lg:overflow-hidden z-[1] group-hover:text-white">
								<h5 class="mb-[10px]">Open & Closing</h5>
								<p class="text-base max-2lg:text-sm max-xl:break-words mb-4 leading-[1.5] group-hover:text-white">Mon - Fri: 09:00am <br>to  07.00pm </p>
								<div class="effect absolute block rounded-[50%] z-[-1] translate-x-[-50%] translate-y-[-50%] bg-primary w-0 h-0 duration-500 group-hover:w-[300%] group-hover:h-[300%]"></div>
							</div>
						</div>
					</div>
				...
				<div class="mb-[50px] max-xl:mb-[30px] relative mx-auto text-center">
                    <h2 class="font-lobster">Reservation</h2>
                </div>
				<form class="dzForm dezPlaceAni" method="POST" action="https://swigo.dexignzone.com/tailwind/xhtml/assets/script/contact_smtp.php">
					<div class="dzFormMsg"></div>
					<input type="hidden" class="form-control" name="dzToDo" value="Contact" >
					<div class="row">
						<div class="md:w-1/2 w-full mb-[30px] sm:mb-[50px] px-[15px]">
							<label class="form-label text-sm font-medium mb-[10px] text-primary">Your Name</label>
							<div class="input-group m-0 relative flex flex-wrap items-center border-b border-white input-line input-black">
								<input name="dzName" required type="text" class="form-control bg-transparent h-[48px] leading-6 p-0 pb-[10px] border-0 placeholder:text-black2 outline-none" placeholder="John Doe">
							</div>
						</div>
						<div class="md:w-1/2 w-full mb-[30px] sm:mb-[50px] px-[15px]">
							<label class="form-label text-sm font-medium mb-[10px] text-primary">Your Email</label>
							<div class="input-group m-0 relative flex flex-wrap items-center border-b border-white input-line input-black">
								<input name="dzEmail" required type="text" class="form-control bg-transparent h-[48px] leading-6 p-0 pb-[10px] border-0 placeholder:text-black2 outline-none" placeholder="info@example.com">
							</div>
						</div>
						<div class="md:w-1/2 w-full mb-[30px] sm:mb-[50px] px-[15px]">
							<label class="form-label text-sm font-medium mb-[10px] text-primary">Your Number</label>
							<div class="input-group m-0 relative flex flex-wrap items-center border-b border-white input-line input-black">
								<input name="dzPhoneNumber" required type="text" class="form-control bg-transparent h-[48px] leading-6 p-0 pb-[10px] border-0 placeholder:text-black2 outline-none dz-number" placeholder="9876543210">
							</div>
						</div>
						<div class="md:w-1/2 w-full mb-[30px] sm:mb-[50px] px-[15px]">
							<label class="form-label text-sm font-medium mb-[10px] text-primary">Members</label>
							<div class="input-group m-0 relative flex flex-wrap items-center border-b border-white input-line input-black">
								<input name="dzOther[Person]" required type="text" class="form-control bg-transparent h-[48px] leading-6 p-0 pb-[10px] border-0 placeholder:text-black2 outline-none" placeholder="1 Person">
							</div>
						</div>
						<div class="w-full px-[15px] mb-[40px]">
							<label class="form-label text-primary">Message</label>
							<div class="input-group m-0 relative flex flex-wrap items-center border-b border-white input-line input-black">
								<textarea name="dzMessage" required class="form-control bg-transparent resize-none h-[105px] w-full leading-6 p-0 pb-[10px] border-0 placeholder:text-black2" placeholder="Hi, do you Have a moment to talk About !"></textarea>
							</div>
						</div>
