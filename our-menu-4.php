...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/our-menu-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:38 GMT -->
<head>	
...
<body id="bg" class="box-border m-0 selection:bg-primary selection:text-white font-poppins">
    ...
    <!-- Banner  -->
    <section class="bg-[url('../images/banner/bnr4.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Our Menu 4</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] pl-2 font-normal active">Our Menu 4</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
			...
			<div class="container">
                    ...
                    <div class="xl:w-10/12 lg:w-9/12 w-full px-[15px]">
                        <div class="site-filters lg:mb-10 mb-[30px] sm:text-left text-center">
                            <ul class="filters style-1">
                                ...
                                <li data-filter=".salad" class="btn lg:py-2 lg:px-[15px] p-2 lg:mr-[10px] mr-[5px] duration-500">
                                ...
                                <li data-filter=".sweet" class="btn lg:py-2 lg:px-[15px] p-2 lg:mr-[10px] mr-[5px] duration-500">
                                ...
                                <li data-filter=".spicy" class="btn lg:py-2 lg:px-[15px] p-2 lg:mr-[10px] mr-[5px] duration-500">
                                ...
                                <li data-filter=".burger" class="btn lg:py-2 lg:px-[15px] p-2 lg:mr-[10px] mr-[5px] duration-500">
				...
				<div class="clearfix" id="lightgallery">
					<ul id="masonry" class="row dlab-gallery-listing gallery">
							...
							<div class="dz-img-box3 box-hover group style-4 bg-white p-[18px] flex flex-col h-[160px] relative z-[1] overflow-hidden rounded-[10px]">
								<div class="menu-detail flex items-center mb-3">
									...
									<div class="dz-content">
										<h5 class="title mb-[3px] duration-500"><a href="product-detail.html">Burger</a></h5>
						...
						<li class="card-container xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All salad burger">
							<div class="dz-img-box3 box-hover group style-4 bg-white p-[18px] flex flex-col h-[160px] relative z-[1] overflow-hidden rounded-[10px]">
								<div class="menu-detail flex items-center mb-3">
									<div class="dz-media mr-5 w-[60px] min-w-[60px] h-[60px]">
									...
									<div class="dz-content">
										<h5 class="title mb-[3px] duration-500"><a href="product-detail.html">Hot Rice</a></h5>
										<p>Delicious and Spicy</p>
									</div>
								</div>
								<div class="menu-footer max-w-[110px] mt-auto">
						...
						<li class="card-container xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All drink sweet">
							<div class="dz-img-box3 box-hover group style-4 bg-white p-[18px] flex flex-col h-[160px] relative z-[1] overflow-hidden rounded-[10px]">
								<div class="menu-detail flex items-center mb-3">
									<div class="dz-media mr-5 w-[60px] min-w-[60px] h-[60px]">
									...
									<div class="dz-content">
										<h5 class="title mb-[3px] duration-500"><a href="product-detail.html">Momos</a></h5>
										<p>Delicious and Spicy</p>
									</div>
								</div>
								<div class="menu-footer max-w-[110px] mt-auto">
						...
						<li class="card-container xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All pizza burger">
							<div class="dz-img-box3 box-hover group style-4 bg-white p-[18px] flex flex-col h-[160px] relative z-[1] overflow-hidden rounded-[10px]">
								<div class="menu-detail flex items-center mb-3">
									<div class="dz-media mr-5 w-[60px] min-w-[60px] h-[60px]">
									...
									<div class="dz-content">
										<h5 class="title mb-[3px] duration-500"><a href="product-detail.html">Pasta</a></h5>
										<p>Delicious and Spicy</p>
									</div>
								</div>
								<div class="menu-footer max-w-[110px] mt-auto">
						...
						<li class="card-container xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All drink spicy">
							<div class="dz-img-box3 box-hover group style-4 bg-white p-[18px] flex flex-col h-[160px] relative z-[1] overflow-hidden rounded-[10px]">
								<div class="menu-detail flex items-center mb-3">
									<div class="dz-media mr-5 w-[60px] min-w-[60px] h-[60px]">
									...
									<div class="dz-content">
										<h5 class="title mb-[3px] duration-500"><a href="product-detail.html">Panner</a></h5>
										<p>Delicious and Spicy</p>
									</div>
								</div>
								<div class="menu-footer max-w-[110px] mt-auto">
						...
						<li class="card-container xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All drink sweet">
							<div class="dz-img-box3 box-hover group style-4 bg-white p-[18px] flex flex-col h-[160px] relative z-[1] overflow-hidden rounded-[10px]"">
								<div class="menu-detail flex items-center mb-3">
									...
									<div class="dz-content">
										<h5 class="title mb-[3px] duration-500"><a href="product-detail.html">Soya Rice</a></h5>
										<p>Delicious and Spicy</p>
									</div>
								</div>
								<div class="menu-footer max-w-[110px] mt-auto">
						...
						<li class="card-container xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All salad burger">
							<div class="dz-img-box3 box-hover group style-4 bg-white p-[18px] flex flex-col h-[160px] relative z-[1] overflow-hidden rounded-[10px]"">
								<div class="menu-detail flex items-center mb-3">
									...
									<div class="dz-content">
										<h5 class="title mb-[3px] duration-500"><a href="product-detail.html">Potato Stick</a></h5>
										<p>Delicious and Spicy</p>
									</div>
								</div>
								<div class="menu-footer max-w-[110px] mt-auto">
						...
						<li class="card-container xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All drink salad">
							<div class="dz-img-box3 box-hover group style-4 bg-white p-[18px] flex flex-col h-[160px] relative z-[1] overflow-hidden rounded-[10px]"">
							<div class="menu-detail flex items-center mb-3">
								<div class="dz-media mr-5 w-[60px] min-w-[60px] h-[60px]">
								...
								<div class="dz-content">
									<h5 class="title mb-[3px] duration-500"><a href="product-detail.html">Salad</a></h5>
									<p>Delicious and Spicy</p>
								</div>
							</div>
							<div class="menu-footer max-w-[110px] mt-auto">
						...
						<li class="card-container xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All drink burger">
							<div class="dz-img-box3 box-hover group style-4 bg-white p-[18px] flex flex-col h-[160px] relative z-[1] overflow-hidden rounded-[10px]"">
							<div class="menu-detail flex items-center mb-3">
								<div class="dz-media mr-5 w-[60px] min-w-[60px] h-[60px]">
								...
								<div class="dz-content">
									<h5 class="title mb-[3px] duration-500"><a href="product-detail.html">Veg Soup</a></h5>
									<p>Delicious and Spicy</p>
								</div>
							</div>
							<div class="menu-footer max-w-[110px] mt-auto">
						...
						<li class="card-container xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All sweet spicy">
							<div class="dz-img-box3 box-hover group style-4 bg-white p-[18px] flex flex-col h-[160px] relative z-[1] overflow-hidden rounded-[10px]"">
							<div class="menu-detail flex items-center mb-3">
								<div class="dz-media mr-5 w-[60px] min-w-[60px] h-[60px]">
						...
						<li class="card-container xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All pizza burger">
							...
							<div class="menu-detail flex items-center mb-3">
								...
								<div class="dz-content">
									<h5 class="title mb-[3px] duration-500"><a href="product-detail.html">Noodles</a></h5>
									<p>Delicious and Spicy</p>
								</div>
							</div>
							<div class="menu-footer max-w-[110px] mt-auto">
						...
						<li class="card-container xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All drink sweet spicy">
							<div class="dz-img-box3 box-hover group style-4 bg-white p-[18px] flex flex-col h-[160px] relative z-[1] overflow-hidden rounded-[10px]"">
							<div class="menu-detail flex items-center mb-3">
								<div class="dz-media mr-5 w-[60px] min-w-[60px] h-[60px]">
								...
								<div class="dz-content">
									<h5 class="title mb-[3px] duration-500"><a href="product-detail.html">Fish Fry</a></h5>
									<p>Delicious and Spicy</p>
								</div>
							</div>
							<div class="menu-footer max-w-[110px] mt-auto">
						...
						<li class="card-container xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All pizza spicy">
							<div class="dz-img-box3 box-hover group style-4 bg-white p-[18px] flex flex-col h-[160px] relative z-[1] overflow-hidden rounded-[10px]">
								<div class="menu-detail flex items-center mb-3">
									...
									<div class="dz-content">
										<h5 class="title mb-[3px] duration-500"><a href="product-detail.html">Aloo Tikki</a></h5>
										<p>Delicious and Spicy</p>
									</div>
								</div>
								<div class="menu-footer max-w-[110px] mt-auto">
						...
						<li class="card-container xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full pl-[15px] pr-[15px] pb-[30px] All drink sweet">
							<div class="dz-img-box3 box-hover group style-4 bg-white p-[18px] flex flex-col h-[160px] relative z-[1] overflow-hidden rounded-[10px]">
								<div class="menu-detail flex items-center mb-3">
									...
									<div class="dz-content">
										<h5 class="title mb-[3px] duration-500"><a href="product-detail.html">Pizza</a></h5>
										<p>Delicious and Spicy</p>
									</div>
								</div>
								<div class="menu-footer max-w-[110px] mt-auto">
					...
					<div class="offcanvas-body">
						<div class="widget mb-[30px]">
							...
							<div class="category-check-list flex flex-wrap mb-[10px] w-full">
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-01">
										Pizza
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-02">
										Hamburger
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-03">
										Cold Drink
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-04">
										Sandwich
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-05">
										Muffin
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-06">
										Burrito
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-07">
										Taco
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-08">
										Hot Dog
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-09">
										Noodles
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-10">
										Macrony
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-11">
										Cheese Pasta
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-12">
										Fish Fry
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-13">
										Cold Coffee
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-14">
										Manchurian
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-15">
										Dosa
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-16">
										Momos
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-17">
										Soup
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-18">
										Chicken Burger
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-19">
										Beverages
									</label>
								</div>
								<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
									...
									<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-20">
										Lemon Lime Soda
									</label>
								</div>
							</div>
						...
						<div class="widget mb-[30px]">
							...
							<div class="form-check mb-[10px] block min-h-[1.5rem]">
								...
								<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-21">
									Ortus Restaurant
								</label>
							</div>
							<div class="form-check mb-[10px] block min-h-[1.5rem]">
								...
								<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-22">
							...
							<div class="form-check mb-[10px] block min-h-[1.5rem]">
								...
								<label class="form-check-label ml-[15px] md:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-23">
									Other
								</label>
							</div>
						</div>
...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/our-menu-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:40 GMT -->
</html>