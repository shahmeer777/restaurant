...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/our-menu-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:29:24 GMT -->
<head>	
    ...
    <section class="bg-[url('../images/banner/bnr2.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Our Menu 2</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] font-normal active pl-2">Our Menu 2</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
			...
			<div class="container">
				...
				<div class="clearfix" id="lightgallery">
					<ul id="masonry" class="row dlab-gallery-listing gallery">
						<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] All pizza spicy">
							<div class="dz-img-box8 flex flex-col xl:mb-[45px] mb-[30px]">
								<a href="assets/images/gallery/grid5/pic1.jpg" title="Sweet Cake" data-src="assets/images/gallery/grid5/pic1.jpg" class="dz-media overflow-hidden">
									<img src="assets/images/gallery/grid5/pic1.jpg"  alt="/" class="h-full w-full rounded-[5px] object-cover duration-500">
								</a>
								<div class="dz-content pt-[15px] relative">
									<div class="dz-head flex justify-between items-center">
										<h6><a href="product-detail.html">Sweet Cake</a></h6>
										<span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span>
									</div>
									<p class="category text-[13px] leading-5 uppercase">Fast Food</p>
								</div>
							</div>
						</li>
						<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] All salad burger">
							<div class="dz-img-box8 flex flex-col xl:mb-[45px] mb-[30px]">
								<a href="assets/images/gallery/grid5/pic2.jpg" title="Health Amd Wealth" data-src="assets/images/gallery/grid5/pic2.jpg" class="dz-media overflow-hidden">
									<img src="assets/images/gallery/grid5/pic2.jpg"  alt="/" class="h-full w-full rounded-[5px] object-cover duration-500">
								</a>
								<div class="dz-content pt-[15px] relative">
									<div class="dz-head flex justify-between items-center">
										<h6><a href="product-detail.html">Health And Wealth</a></h6>
										<span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span>
									</div>
									<p class="category text-[13px] leading-5 uppercase">Fast Food</p>
								</div>
						...
						<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] All drink sweet">
							<div class="dz-img-box8 flex flex-col xl:mb-[45px] mb-[30px]">
								<a href="assets/images/gallery/grid5/pic3.jpg" title="Boil Rice" data-src="assets/images/gallery/grid5/pic3.jpg" class="dz-media overflow-hidden">
									<img src="assets/images/gallery/grid5/pic3.jpg"  alt="/" class="h-full w-full rounded-[5px] object-cover duration-500">
								</a>
								<div class="dz-content pt-[15px] relative">
									<div class="dz-head flex justify-between items-center">
										<h6><a href="product-detail.html">Boil Rice</a></h6>
										<span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span>
									</div>
									<p class="category text-[13px] leading-5 uppercase">Fast Food</p>
								</div>
						...
						<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] All pizza burger">
							<div class="dz-img-box8 flex flex-col xl:mb-[45px] mb-[30px]">
								<a href="assets/images/gallery/grid5/pic4.jpg" title="Burger & Frence Fries" data-src="assets/images/gallery/grid5/pic4.jpg" class="dz-media overflow-hidden">
									<img src="assets/images/gallery/grid5/pic4.jpg"  alt="/" class="h-full w-full rounded-[5px] object-cover duration-500">
								</a>
								<div class="dz-content pt-[15px] relative">
									<div class="dz-head flex justify-between items-center">
										<h6><a href="product-detail.html">Burger & Frence Fries</a></h6>
										<span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span>
									</div>
									<p class="category text-[13px] leading-5 uppercase">Fast Food</p>
								</div>
						...
						<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] All drink spicy">
							<div class="dz-img-box8 flex flex-col xl:mb-[45px] mb-[30px]">
								<a href="assets/images/gallery/grid5/pic5.jpg" title="Nonveg Biryani" data-src="assets/images/gallery/grid5/pic5.jpg" class="dz-media overflow-hidden">
									<img src="assets/images/gallery/grid5/pic5.jpg"  alt="/" class="h-full w-full rounded-[5px] object-cover duration-500">
								</a>
								<div class="dz-content pt-[15px] relative">
									<div class="dz-head flex justify-between items-center">
										<h6><a href="product-detail.html">Nonveg Biryani</a></h6>
										<span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span>
									</div>
									<p class="category text-[13px] leading-5 uppercase">Fast Food</p>
								</div>
						...
						<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] All drink sweet">
							<div class="dz-img-box8 flex flex-col xl:mb-[45px] mb-[30px]">
								<a href="assets/images/gallery/grid5/pic6.jpg" title="Honey Bread" data-src="assets/images/gallery/grid5/pic6.jpg" class="dz-media overflow-hidden">
									<img src="assets/images/gallery/grid5/pic6.jpg"  alt="/" class="h-full w-full rounded-[5px] object-cover duration-500">
								</a>
								<div class="dz-content pt-[15px] relative">
									<div class="dz-head flex justify-between items-center">
										<h6><a href="product-detail.html">Honey Bread</a></h6>
										<span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span>
									</div>
									<p class="category text-[13px] leading-5 uppercase">Fast Food</p>
								</div>
						...
						<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] All salad burger">
							<div class="dz-img-box8 flex flex-col xl:mb-[45px] mb-[30px]">
								<a href="assets/images/gallery/grid5/pic7.jpg" title="Sweet Potato" data-src="assets/images/gallery/grid5/pic7.jpg" class="dz-media overflow-hidden">
									<img src="assets/images/gallery/grid5/pic7.jpg"  alt="/" class="h-full w-full rounded-[5px] object-cover duration-500">
								</a>
								<div class="dz-content pt-[15px] relative">
									<div class="dz-head flex justify-between items-center">
										<h6><a href="product-detail.html">Sweet Potato</a></h6>
										<span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span>
									</div>
									<p class="category text-[13px] leading-5 uppercase">Fast Food</p>
								</div>
						...
						<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] All drink salad">
							<div class="dz-img-box8 flex flex-col xl:mb-[45px] mb-[30px]">
								<a href="assets/images/gallery/grid5/pic8.jpg" title="Veg Sauce" data-src="assets/images/gallery/grid5/pic8.jpg" class="dz-media overflow-hidden">
									<img src="assets/images/gallery/grid5/pic8.jpg"  alt="/" class="h-full w-full rounded-[5px] object-cover duration-500">
								</a>
								<div class="dz-content pt-[15px] relative">
									<div class="dz-head flex justify-between items-center">
										<h6><a href="product-detail.html">Veg Sauce</a></h6>
										<span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span>
									</div>
									<p class="category text-[13px] leading-5 uppercase">Fast Food</p>
								</div>
						...
						<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] All drink burger">
							<div class="dz-img-box8 flex flex-col xl:mb-[45px] mb-[30px]">
								<a href="assets/images/gallery/grid5/pic9.jpg" title="Chilla" data-src="assets/images/gallery/grid5/pic9.jpg" class="dz-media overflow-hidden">
									<img src="assets/images/gallery/grid5/pic9.jpg"  alt="/" class="h-full w-full rounded-[5px] object-cover duration-500">
								</a>
								<div class="dz-content pt-[15px] relative">
									<div class="dz-head flex justify-between items-center">
										<h6><a href="product-detail.html">Chilla</a></h6>
										<span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span>
									</div>
									<p class="category text-[13px] leading-5 uppercase">Fast Food</p>
								</div>
						...
						<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] All sweet spicy">
							<div class="dz-img-box8 flex flex-col xl:mb-[45px] mb-[30px]">
								<a href="assets/images/gallery/grid5/pic10.jpg" title="Crapse food" data-src="assets/images/gallery/grid5/pic10.jpg" class="dz-media overflow-hidden">
									<img src="assets/images/gallery/grid5/pic10.jpg"  alt="/" class="h-full w-full rounded-[5px] object-cover duration-500">
								</a>
								<div class="dz-content pt-[15px] relative">
									<div class="dz-head flex justify-between items-center">
										<h6><a href="product-detail.html">Crapse food</a></h6>
										<span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span>
									</div>
									<p class="category text-[13px] leading-5 uppercase">Fast Food</p>
								</div>
						...
						<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] All pizza burger">
							<div class="dz-img-box8 flex flex-col xl:mb-[45px] mb-[30px]">
								<a href="assets/images/gallery/grid5/pic11.jpg" title="Pizza" data-src="assets/images/gallery/grid5/pic11.jpg" class="dz-media overflow-hidden">
									<img src="assets/images/gallery/grid5/pic11.jpg"  alt="/" class="h-full w-full rounded-[5px] object-cover duration-500">
								</a>
								<div class="dz-content pt-[15px] relative">
									<div class="dz-head flex justify-between items-center">
										<h6><a href="product-detail.html">Pizza</a></h6>
										<span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span>
									</div>
									<p class="category text-[13px] leading-5 uppercase">Fast Food</p>
								</div>
						...
						<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] All drink sweet spicy">
							<div class="dz-img-box8 flex flex-col xl:mb-[45px] mb-[30px]">
								<a href="assets/images/gallery/grid5/pic12.jpg" title="Donets" data-src="assets/images/gallery/grid5/pic12.jpg" class="dz-media overflow-hidden">
									<img src="assets/images/gallery/grid5/pic12.jpg"  alt="/" class="h-full w-full rounded-[5px] object-cover duration-500">
								</a>
								<div class="dz-content pt-[15px] relative">
									<div class="dz-head flex justify-between items-center">
										<h6><a href="product-detail.html">Donets</a></h6>
										<span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span>
									</div>
									<p class="category text-[13px] leading-5 uppercase">Fast Food</p>
								</div>
...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/our-menu-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:29:44 GMT -->
</html>