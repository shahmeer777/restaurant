...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/blog-wide-grid-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:53 GMT -->
<head>	
    ...
    <section class="bg-[url('../images/banner/bnr2.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] overflow-hidden lg:h-[450px] md:h-[400px] h-[320px] bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] xl:text-[60px] md:text-[50px] text-[40px] leading-[1.1]">Blog Wide Grid Sidebar</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] pl-2 font-normal active">Blog Wide Grid Sidebar</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
            ...
            <div class="row">
                <div class="xl:w-9/12 lg:w-8/12 w-full px-[15px]">
                    <div class="row loadmore-content">
                        <div class="w-1/3 max-2lg:w-1/2 px-[15px] blog-detail">
                            <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] bg-white group mb-[30px]">
                                <div class="dz-media w-full h-full mb-0 relative overflow-hidden">
                                    <a href="javascript:void(0);" class="block">
                                        <img src="assets/images/blog/grid3/pic1.jpg" alt="/" class="block w-full group-hover:scale-110 duration-500">
                                    </a>
                                </div>
                                <div class="content flex-col flex p-[30px] max-xl:p-5 relative">
                                    <div class="mb-2.5">
                                        <ul class="flex">
                                            ...
                                            <li class="inline-block relative text-[13px] mr-3">
                                                <a href="javascript:void(0);" class="text-sm font-medium text-bodycolor"><i class="flaticon-chat-bubble text-base text-primary mr-[5px]"></i> 3.5K </a>
                                            </li>
                                        </ul>
                                    </div>
                                    <h5 class="mb-2">Paradise Taste of Dishes</h5>
                                    <p class="mb-4 text-base">There are many variations of passages of Lorem Ipsum available, but the majority have.</p>
                                    <div>
                                        <a href="blog-standard.html" class="py-3 px-6 btn-hover-2 text-sm font-medium relative inline-flex items-center justify-center rounded-md mt-[18px]  bg-primary border-primary text-white">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="w-1/3 max-2lg:w-1/2 px-[15px] blog-detail">
                            <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] bg-white group mb-[30px]">
                                <div class="dz-media w-full h-full mb-0 relative overflow-hidden">
                                    <a href="javascript:void(0);" class="block">
                                        <img src="assets/images/blog/grid3/pic2.jpg" alt="/" class="block w-full group-hover:scale-110 duration-500">
                                    </a>
                                </div>
                                <div class="content flex-col flex p-[30px] max-xl:p-5 relative">
                                    <div class="mb-2.5">
                        ...
                        <div class="w-1/3 max-2lg:w-1/2 px-[15px] blog-detail">
                            <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] bg-white group mb-[30px]">
                                <div class="dz-media w-full h-full mb-0 relative overflow-hidden">
                                    <a href="javascript:void(0);" class="block">
                                        <img src="assets/images/blog/grid3/pic3.jpg" alt="/" class="block w-full group-hover:scale-110 duration-500">
                                    </a>
                                </div>
                                <div class="content flex-col flex p-[30px] max-xl:p-5 relative">
                                    <div class="mb-2.5">
                        ...
                        <div class="w-1/3 max-2lg:w-1/2 px-[15px] blog-detail">
                            <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] bg-white group mb-[30px]">
                                <div class="dz-media w-full h-full mb-0 relative overflow-hidden">
                                    <a href="javascript:void(0);" class="block">
                                        <img src="assets/images/blog/grid3/pic4.jpg" alt="/" class="block w-full group-hover:scale-110 duration-500">
                                    </a>
                                </div>
                                <div class="content flex-col flex p-[30px] max-xl:p-5 relative">
                                    <div class="mb-2.5">
                        ...
                        <div class="w-1/3 max-2lg:w-1/2 px-[15px] blog-detail">
                            <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] bg-white group mb-[30px]">
                                <div class="dz-media w-full h-full mb-0 relative overflow-hidden">
                                    <a href="javascript:void(0);" class="block">
                                        <img src="assets/images/blog/grid3/pic5.jpg" alt="/" class="block w-full group-hover:scale-110 duration-500">
                                    </a>
                                </div>
                                <div class="content flex-col flex p-[30px] max-xl:p-5 relative">
                                    <div class="mb-2.5">
                        ...
                        <div class="w-1/3 max-2lg:w-1/2 px-[15px] blog-detail">
                            <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] bg-white group mb-[30px]">
                                <div class="dz-media w-full h-full mb-0 relative overflow-hidden">
                                    <a href="javascript:void(0);" class="block">
                                        <img src="assets/images/blog/grid3/pic6.jpg" alt="/" class="block w-full group-hover:scale-110 duration-500">
                                    </a>
                                </div>
                                <div class="content flex-col flex p-[30px] max-xl:p-5 relative">
                                    <div class="mb-2.5">
