...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:34 GMT -->
<head>	
    ...
    <section class="bg-[url('../images/banner/bnr1.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Services</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] pl-2 font-normal active">Services</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
            ...
            <div class="row">
                <div class="lg:w-1/4 sm:w-1/2 w-full mb-[30px] px-[15px]">
                    <div class="icon-bx-wraper style-3 rounded-[10px] bg-[#2222220d] text-center h-full py-[30px] px-3 border-[2px] border-transparent flex flex-col duration-500 hover:bg-white hover:border-primary hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] hover:translate-y-[-10px]">
                        <div class="icon-bx w-[95px] h-[95px] rounded-full bg-primary mx-auto mb-5 flex items-center justify-center">
                            <div class="icon-cell">
                                <i class="flaticon-vegetable text-[50px] text-white leading-[50px]"></i>
                            </div>
                        </div>
                        <div class="icon-content">
                            <h5 class="mb-2"><a href="service-detail.html">Fresh Products</a></h5>
                ...
                <div class="lg:w-1/4 sm:w-1/2 w-full mb-[30px] px-[15px]">
                    <div class="icon-bx-wraper style-3 rounded-[10px] bg-[#2222220d] text-center h-full py-[30px] px-3 border-[2px] border-transparent flex flex-col duration-500 hover:bg-white hover:border-primary hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] hover:translate-y-[-10px]">
                        <div class="icon-bx w-[95px] h-[95px] rounded-full bg-primary mx-auto mb-5 flex items-center justify-center">
                            <div class="icon-cell">
                                <i class="flaticon-chef-hat text-[50px] text-white leading-[50px]"></i>
                            </div>
                        </div>
                        <div class="icon-content">
                            <h5 class="mb-2"><a href="service-detail.html">Skilled Chefs</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and </p>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/4 sm:w-1/2 w-full mb-[30px] px-[15px]">
                    <div class="icon-bx-wraper style-3 rounded-[10px] bg-[#2222220d] text-center h-full py-[30px] px-3 border-[2px] border-transparent flex flex-col duration-500 hover:bg-white hover:border-primary hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] hover:translate-y-[-10px]">
                        <div class="icon-bx w-[95px] h-[95px] rounded-full bg-primary mx-auto mb-5 flex items-center justify-center">
                            <div class="icon-cell">
                                <i class="flaticon-cocktail text-[50px] text-white leading-[50px]"></i>
                            </div>
                        </div>
                        <div class="icon-content">
                            <h5 class="mb-2"><a href="service-detail.html">Best Bar</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and </p>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/4 sm:w-1/2 w-full mb-[30px] px-[15px]">
                    <div class="icon-bx-wraper style-3 rounded-[10px] bg-[#2222220d] text-center h-full py-[30px] px-3 border-[2px] border-transparent flex flex-col duration-500 hover:bg-white hover:border-primary hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] hover:translate-y-[-10px]">
                        <div class="icon-bx w-[95px] h-[95px] rounded-full bg-primary mx-auto mb-5 flex items-center justify-center">
                            <div class="icon-cell">
                                <i class="flaticon-cuisine text-[50px] text-white leading-[50px]"></i>
                            </div>
                        </div>
                        <div class="icon-content">
                            <h5 class="mb-2"><a href="service-detail.html">Vegan Cuisine</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and </p>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/4 sm:w-1/2 w-full mb-[30px] px-[15px]">
                    <div class="icon-bx-wraper style-3 rounded-[10px] bg-[#2222220d] text-center h-full py-[30px] px-3 border-[2px] border-transparent flex flex-col duration-500 hover:bg-white hover:border-primary hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] hover:translate-y-[-10px]">
                        <div class="icon-bx w-[95px] h-[95px] rounded-full bg-primary mx-auto mb-5 flex items-center justify-center">
                            <div class="icon-cell">
                                <i class="flaticon-support text-[50px] text-white leading-[50px]"></i>
                            </div>
                        </div>
                        <div class="icon-content">
                            <h5 class="mb-2"><a href="service-detail.html">Free Supports</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and </p>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/4 sm:w-1/2 w-full mb-[30px] px-[15px]">
                    <div class="icon-bx-wraper style-3 rounded-[10px] bg-[#2222220d] text-center h-full py-[30px] px-3 border-[2px] border-transparent flex flex-col duration-500 hover:bg-white hover:border-primary hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] hover:translate-y-[-10px]">
                        <div class="icon-bx w-[95px] h-[95px] rounded-full bg-primary mx-auto mb-5 flex items-center justify-center">
                            <div class="icon-cell">
                                <i class="flaticon-room-service text-[50px] text-white leading-[50px]"></i>
                            </div>
                        </div>
                        <div class="icon-content">
                            <h5 class="mb-2"><a href="service-detail.html">Fast Serve On Table</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and </p>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/4 sm:w-1/2 w-full mb-[30px] px-[15px]">
                    <div class="icon-bx-wraper style-3 rounded-[10px] bg-[#2222220d] text-center h-full py-[30px] px-3 border-[2px] border-transparent flex flex-col duration-500 hover:bg-white hover:border-primary hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] hover:translate-y-[-10px]">
                        <div class="icon-bx w-[95px] h-[95px] rounded-full bg-primary mx-auto mb-5 flex items-center justify-center">
                            <div class="icon-cell">
                                <i class="flaticon-pot text-[50px] text-white leading-[50px]"></i>
                            </div>
                        </div>
                        <div class="icon-content">
                            <h5 class="mb-2"><a href="service-detail.html">Fresh Healthy Food</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and </p>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/4 sm:w-1/2 w-full mb-[30px] px-[15px]">
                    <div class="icon-bx-wraper style-3 rounded-[10px] bg-[#2222220d] text-center h-full py-[30px] px-3 border-[2px] border-transparent flex flex-col duration-500 hover:bg-white hover:border-primary hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] hover:translate-y-[-10px]">
                        <div class="icon-bx w-[95px] h-[95px] rounded-full bg-primary mx-auto mb-5 flex items-center justify-center">
                            <div class="icon-cell">
                                <i class="flaticon-fast-delivery text-[50px] text-white leading-[50px]"></i>
                            </div>
                        </div>
                        <div class="icon-content">
                            <h5 class="mb-2"><a href="service-detail.html">Quick Delivery</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and </p>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/4 sm:w-1/2 w-full mb-[30px] px-[15px]">
                    <div class="icon-bx-wraper style-3 rounded-[10px] bg-[#2222220d] text-center h-full py-[30px] px-3 border-[2px] border-transparent flex flex-col duration-500 hover:bg-white hover:border-primary hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] hover:translate-y-[-10px]">
                        <div class="icon-bx w-[95px] h-[95px] rounded-full bg-primary mx-auto mb-5 flex items-center justify-center">
                            <div class="icon-cell">
                                <i class="flaticon-token text-[50px] text-white leading-[50px]"></i>
                            </div>
                        </div>
                        <div class="icon-content">
                            <h5 class="mb-2"><a href="service-detail.html">Order Tokan</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and </p>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/4 sm:w-1/2 w-full mb-[30px] px-[15px]">
                    <div class="icon-bx-wraper style-3 rounded-[10px] bg-[#2222220d] text-center h-full py-[30px] px-3 border-[2px] border-transparent flex flex-col duration-500 hover:bg-white hover:border-primary hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] hover:translate-y-[-10px]">
                        <div class="icon-bx w-[95px] h-[95px] rounded-full bg-primary mx-auto mb-5 flex items-center justify-center">
                            <div class="icon-cell">
                                <i class="flaticon-furniture text-[50px] text-white leading-[50px]"></i>
                            </div>
                        </div>
                        <div class="icon-content">
                            <h5 class="mb-2"><a href="service-detail.html">Table Service</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and </p>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/4 sm:w-1/2 w-full mb-[30px] px-[15px]">
                    <div class="icon-bx-wraper style-3 rounded-[10px] bg-[#2222220d] text-center h-full py-[30px] px-3 border-[2px] border-transparent flex flex-col duration-500 hover:bg-white hover:border-primary hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] hover:translate-y-[-10px]">
                        <div class="icon-bx w-[95px] h-[95px] rounded-full bg-primary mx-auto mb-5 flex items-center justify-center">
                            <div class="icon-cell">
                                <i class="flaticon-team text-[50px] text-white leading-[50px]"></i>
                            </div>
                        </div>
                        <div class="icon-content">
                            <h5 class="mb-2"><a href="service-detail.html">Awesome Team</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and </p>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/4 sm:w-1/2 w-full mb-[30px] px-[15px]">
                    <div class="icon-bx-wraper style-3 rounded-[10px] bg-[#2222220d] text-center h-full py-[30px] px-3 border-[2px] border-transparent flex flex-col duration-500 hover:bg-white hover:border-primary hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] hover:translate-y-[-10px]">
                        <div class="icon-bx w-[95px] h-[95px] rounded-full bg-primary mx-auto mb-5 flex items-center justify-center">
                            <div class="icon-cell">
                                <i class="flaticon-offer text-[50px] text-white leading-[50px]"></i>
                            </div>
                        </div>
                        <div class="icon-content">
                            <h5 class="mb-2"><a href="service-detail.html">Discount Voucher</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and </p>
                        </div>
                    </div>
                </div>
