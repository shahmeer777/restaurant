...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/blog-grid-4-masonary.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:52 GMT -->
<head>	
    ...
    <section class="bg-[url('../images/banner/bnr5.jpg')] bg-fixed  relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] overflow-hidden lg:h-[450px] md:h-[400px] h-[320px] bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Blog Grid 4 Masonry</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] pl-2 font-normal active">Blog Grid 4 Masonry</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
		...
		<section class="lg:pt-[100px] sm:pt-[70px] pt-[50px] lg:pb-[70px] sm:pb-10 pb-5">
			<div class="container-fluid px-[30px] max-xl:px-5 mx-auto relative">
				<div id="masonry" class="row" data-masonry='{"percentPosition": true}'>
					<div class="card-container xl:w-1/4 lg:w-2/6 md:w-1/2 w-full px-[15px]">
					...
					<div class="card-container xl:w-1/4 lg:w-2/6 md:w-1/2 w-full px-[15px]">
						<div class="dz-card rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] bg-white group mb-[30px]">
							...
							<div class="content flex-col flex p-[30px] max-xl:p-5 relative">
                                <div class="mb-2.5">
                                    <ul class="flex">
                                        <li class="inline-block relative text-[13px] mr-3">
                                            <a href="javascript:void(0);" class="text-sm font-medium text-bodycolor"><i class="flaticon-calendar-date text-xs text-primary mr-[5px] translate-y-[1px] scale-150"></i> 10 Mar 2024</a>
                                        </li>
                                        <li class="inline-block relative text-[13px] mr-3">
											<a href="javascript:void(0);" class="text-sm font-medium text-bodycolor"><i class="flaticon-chat-bubble text-base text-primary mr-[5px]"></i> 1.0K </a>
                                        </li>
                                    </ul>
                                </div>
					...
					<div class="card-container xl:w-1/4 lg:w-2/6 md:w-1/2 w-full px-[15px]">
						<div class="dz-card style-3 dz-card-large blog-half relative min-h-[570px] h-full overflow-hidden rounded-lg flex flex-col mb-[30px]" style="background-image: url(assets/images/blog/large/pic1.jpg)">
							<div class="dz-info p-[30px] z-[1] mt-auto">
                                <h4 class="dz-title mb-[15px]"><a href="blog-standard.html" class="text-white">Exploring Pizza</a></h4>
                                <div class="dz-meta mb-[15px]">
                                    <ul>
                                        <li class="dz-date absolute top-[35px] left-[35px] after:hidden py-[10px] px-[25px] block duration-1000 hover:text-primary hover:bg-white">14 Feb 2024</li>
                                        <li class="dz-user">
					...
					<div class="card-container xl:w-1/4 lg:w-2/6 md:w-1/2 w-full px-[15px]">
						<blockquote class="wp-block-quote style-1 text-primary xl:pt-5 md:pt-[25px] md:pr-[2rem] md:pb-5 md:pl-7 p-5 shadow-[0px_15px_50px_rgba(34,34,34,0.15)] rounded-[10px] relative mb-[30px]">
							<p class="xl:text-[22px] md:text-lg text-base xl:leading-[1.5] leading-[22px] text-black2 mb-4">Create An Information That’s Easy To Use Usability Considerations For Partially</p>
					...
					<div class="card-container xl:w-1/4 lg:w-2/6 md:w-1/2 w-full px-[15px]">
						<div class="dz-card rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] bg-white group mb-[30px]">
							<div class="service-swiper swiper">
								...
								<div class="swiper-pagination style-1"></div>
								<div class="service-button-prev btn-prev absolute rounded-full top-[50%] bg-white text-primary hover:bg-primary hover:text-white translate-y-[-50%]"><i class="icon-arrow-left"></i></div>
								<div class="service-button-next btn-next absolute rounded-full top-[50%] bg-white text-primary hover:bg-primary hover:text-white translate-y-[-50%] right-0"><i class="icon-arrow-right"></i></div>
							</div>
							<div class="content flex-col flex p-[30px] max-xl:p-5 relative">
								<div class="mb-2.5">
									<ul class="flex">
								...
								<p class="text-base">There are many variations of passages of Lorem Ipsum available, but the majority have.</p>
								<div>
									<a href="javascript:void(0);" class="py-3 px-6 text-sm font-medium relative inline-flex items-center justify-center rounded-md mt-[18px]  bg-primary border-primary text-white btn-hover-2">Read More</a>
								</div>
							</div>
						</div>
					</div>
                            ...
                            <div class="content flex-col flex p-[30px] max-xl:p-5 relative">
                                <div class="mb-2.5">
                                    <ul class="flex">
                                        ...
                                        <li class="inline-block relative text-[13px] mr-3">
											<a href="javascript:void(0);" class="text-sm font-medium text-bodycolor"><i class="flaticon-chat-bubble text-xs text-primary mr-[5px] translate-y-[1px] scale-150"></i> 3.5K </a></li>
                                        
                                    </ul>
                                </div>
                                <h5 class="mb-2">Enchanting Dishes That Will Transport You to Food Heaven</h5>
                                <p class="text-base">There are many variations of passages of Lorem Ipsum available, but the majority have.</p>
                                <div>
                                    <a href="blog-standard.html" class="py-3 px-6 text-sm font-medium relative inline-flex items-center justify-center rounded-md mt-[18px]  bg-primary border-primary text-white btn-hover-2">Read More</a>
                                </div>
					...
					<div class="card-container xl:w-1/4 lg:w-2/6 md:w-1/2 w-full px-[15px]">
						<div class="overlay-shine dz-card blog-half rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] bg-white group mb-[30px]">
                            <div class="dz-media w-full h-full mb-0 relative overflow-hidden">
                                <a href="javascript:void(0);" class="block">
                            ...
                            <div class="content flex-col flex p-[30px] max-xl:p-5 relative">
								<h5 class="mb-[15px]">Amazing Taste</h5>
                                <div class="dz-meta mb-[15px]">
									<ul>
										<li class="dz-user">
                                ...
                                <p class="text-base">Nostrud tem exrcitation duis laboris nisi ut aliquip sed duis aute cupidata.</p>
                            </div>
                        </div>
					</div>
					<div class="card-container xl:w-1/4 lg:w-2/6 md:w-1/2 w-full px-[15px]">
						<div class="overlay-shine dz-card blog-half rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] bg-white group mb-[30px]">
                            ...
                            <div class="content flex-col flex p-[30px] max-xl:p-5 relative">
                                <h5 class="mb-[15px]">Taste Excitment</h5>								
                                <div class="dz-meta mb-[15px]">
									<ul>
										<li class="dz-user">
											<a href="javascript:void(0);" class="text-black2"><i class="fa-solid fa-user text-xs text-primary mr-[5px] relative top-0 scale-[1.2]"></i>
					...
					<div class="card-container xl:w-1/4 lg:w-2/6 md:w-1/2 w-full px-[15px]">
						<div class="dz-card style-3 dz-card-large blog-half relative min-h-[570px] h-full overflow-hidden rounded-lg flex flex-col mb-[30px]" style="background-image: url(assets/images/blog/large/pic1.jpg)">
							<div class="dz-info p-[30px] z-[1] mt-auto">
                                ...
                                <div class="dz-meta mb-[15px]">
                                    <ul>
                                        <li class="dz-date absolute top-[35px] left-[35px] after:hidden py-[10px] px-[25px] block">14 Feb 2024</li>
                                        <li class="dz-user">
                                            <a href="javascript:void(0);" class="text-white"><i class="fa-solid fa-user text-xs text-primary mr-[5px] relative top-0 scale-[1.2]"></i>
                                            By <span class="text-primary">RK Gupta</span></a>
                                        </li>
