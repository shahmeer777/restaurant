...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/blog-wide-list-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:52 GMT -->
<head>	
...
<body id="bg" class="box-border m-0 selection:bg-primary selection:text-white font-poppins">
	...
	<!-- Banner  -->
    <section class="bg-[url('../images/banner/bnr5.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] overflow-hidden lg:h-[450px] md:h-[400px] h-[320px] bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] xl:text-[60px] md:text-[50px] text-[40px] leading-[1.1]">Blog Wide List Sidebar</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] font-normal pl-2 active">Blog Wide List Sidebar</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
	...
	<section class="lg:pt-[100px] sm:pt-[70px] pt-[50px] lg:pb-[70px] sm:pb-10 pb-5">
        <div class="container-fluid px-[30px] max-xl:px-5 mx-auto relative">
            <div class="row">
				<div class="xl:w-9/12 lg:w-8/12 w-full px-[15px]">
                    <div class="row">
                        <div class="xl:w-1/2 w-full px-[15px]">
                            <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] sm:flex bg-white group mb-[30px]">
                                ...
                                <div class="content flex-col flex py-[25px] px-[30px] relative">
                                    <div class="mb-2.5">
                                        <ul class="flex items-center max-xl:block">
                                            ...
                                            <li class="inline-block"><a href="javascript:void(0);" class="text-sm font-medium text-bodycolor"><i class="flaticon-chat-bubble text-base text-primary mr-[5px]"></i> 3.5K </a></li>
                                        </ul>
                                    </div>
                                    <h5 class="mb-2">Paradise Taste of Dishes</h5>
                                    <p class="mb-4">There are many variations of passages of Lorem Ipsum.</p>
                                    <div class="mt-auto">
                                        <a href="blog-standard.html" class="py-3 px-6 btn-hover-2 text-sm font-medium relative inline-flex items-center justify-center rounded-md bg-primary border-primary text-white">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center mx-auto mt-[10px]">
                            <ul class="pagination flex justify-center mb-[15px]">
                                ...
                                <li class="page-item mx-2"><a class="page-link w-[45px] min-w-[45px] leading-[45px] text-center rounded-lg shadow-[0px_5px_25px_rgba(0,0,0,0.1)] block relative duration-500 bg-primary text-white active" href="javascript:void(0);"><span>1</span></a></li>
                ...
                <div class="xl:w-1/4 lg:w-1/3 w-full px-[15px]">
