...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/shop-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:42 GMT -->
<head>	
    ...
    <section class="bg-[url('../images/banner/bnr3.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Shop Checkout</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] font-normal pl-2 active">Shop Checkout</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
                    ...
                    <div class="lg:w-1/2 w-full px-[15px]">
                        <div class="widget mb-[50px]">
                            ...
                            <div class="form-group mb-5 inline-block w-full">
                                <select class="form-select nice-select after:border-black2 after:h-2 after:w-2 after:right-5 after:top-[60%] w-full">
                            ...
                            <div class="row">
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzFirstName" required type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="First Name">
                                </div>
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzLastName" required type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Last Name">
                                </div>
                            </div>
                            <div class="form-group mb-5">
                                <input name="dzOther[CompanyType]" required type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Company Name">
                            </div>
                            <div class="form-group mb-5">
                                <input name="dzOther[Address]" required type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Address">
                            </div>
                            <div class="row">
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzOther[Other]" required type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Apartment, suite, unit etc.">
                                </div>
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzOther[Town/City]" required type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Town / City">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzOther[State/County]" required type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="State / County">
                                </div>
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="Postcode/Zip" required type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Postcode / Zip">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzEmail" required type="email" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Email">
                                </div>
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzPhoneNumber" required type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500 dz-number" placeholder="Phone">
                                </div>
                            </div>
                            <button class="btn bg-[#F3F3F3] gap-[10px] mb-4 shadow-none duration-700 hover:text-white hover:bg-primary create-an-account" type="button">Create an account <i class="fa fa-angle-down text-xl"></i></button>
                            <div id="create-an-account" style="display: none;">
                                <p class="text-base mb-4">Create an account by entering the information below. If you are a returning customer please login at the top of the page.</p>
                                <div class="form-group">
                                    <input name="Password" type="password" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Password">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="lg:w-1/2 w-full px-[15px]">
                        <button class="btn bg-[#F3F3F3] gap-[10px] mb-4 shadow-none duration-700 hover:text-white hover:bg-primary different-address" type="button">Ship to a different address <i class="fa fa-angle-down text-xl"></i></button>
                        <div id="different-address" class="widget"  style="display: none;">
                            <p class="text-base mb-4">If you have shopped with us before, please enter your details in the boxes below. If you are a new customer please proceed to the Billing & Shipping section.</p>
                            <div class="form-group mb-5 inline-block w-full">
                                <select class="form-select nice-select after:border-black2 after:h-2 after:w-2 after:right-5 after:top-[60%]">
                            ...
                            <div class="row">
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzFirstName" type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="First Name">
                                </div>
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzLastName" type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Last Name">
                                </div>
                            </div>
                            <div class="form-group mb-5">
                                <input name="dzFirstName" type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Company Name">
                            </div>
                            <div class="form-group mb-5">
                                <input name="dzOther[Address]" type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Address">
                            </div>
                            <div class="row">
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzOther[Other]" type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Apartment, suite, unit etc.">
                                </div>
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzOther[Town/City]" type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Town / City">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzOther[State/County]" type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="State / County">
                                </div>
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzOther[Postcode/Zip]" type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Postcode / Zip">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzEmail" type="email" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Email">
                                </div>
                                <div class="form-group md:w-1/2 w-full px-[15px] mb-5">
                                    <input name="dzPhoneNumber" type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500 dz-number" placeholder="Phone">
                                </div>
                            </div>
                            <p class="text-base mb-4">Create an account by entering the information below. If you are a returning customer please login at the top of the page.</p>
                        </div>
                        <div class="form-group">
                            <textarea class="resize-none py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" rows="5" placeholder="Notes about your order, e.g. special notes for delivery"></textarea>
                        </div>
                    ...
                    <div class="widget">
                        ...
                        <table class="mb-5 border border-[#00000020] align-middle w-full">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="p-[15px] font-medium border border-[#00000020] product-item-img"><img src="assets/images/gallery/small/pic4.jpg" alt="/" class="w-[100px] rounded-md"></td>
                                    <td class="p-[15px] font-medium border border-[#00000020] text-bodycolor">Prduct Item 4</td>
                                    <td class="p-[15px] font-medium border border-[#00000020] text-bodycolor">$36.00</td>
                                </tr>
                                <tr>
                                    <td class="p-[15px] font-medium product-item-img"><img src="assets/images/gallery/small/pic3.jpg" alt="/" class="w-[100px] rounded-md"></td>
                                    <td class="p-[15px] font-medium border border-[#00000020] text-bodycolor">Prduct Item 3</td>
                                    <td class="p-[15px] font-medium border border-[#00000020] text-bodycolor">$25.00</td>
                                </tr>
                                <tr>
                                    <td class="p-[15px] font-medium border border-[#00000020] product-item-img"><img src="assets/images/gallery/small/pic2.jpg" alt="/" class="w-[100px] rounded-md"></td>
                                    <td class="p-[15px] font-medium border border-[#00000020] text-bodycolor">Prduct Item 2</td>
                                    <td class="p-[15px] font-medium border border-[#00000020] text-bodycolor">$22.00</td>
                                </tr>
                                <tr>
                                    <td class="p-[15px] font-medium border border-[#00000020] product-item-img"><img src="assets/images/gallery/small/pic1.jpg" alt="/" class="w-[100px] rounded-md"></td>
                                    <td class="p-[15px] font-medium border border-[#00000020] text-bodycolor">Prduct Item 1</td>
                                    <td class="p-[15px] font-medium border border-[#00000020] text-bodycolor">$28.00</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="lg:w-1/2 w-full px-[15px]">
                    <form class="shop-form widget">
                        ...
                        <table class="mb-5 border border-[#00000020] align-middle w-full">
                            <tbody>
                                <tr>
                                    <td class="p-[15px] font-medium text-bodycolor border border-[#00000020] ">Order Subtotal</td>
                                    <td class="p-[15px] font-medium text-bodycolor border border-[#00000020]">$125.96</td>
                                </tr>
                                <tr>
                                    <td class="p-[15px] font-medium text-bodycolor border border-[#00000020]">Shipping</td>
                                    <td class="p-[15px] font-medium text-bodycolor border border-[#00000020]">Free Shipping</td>
                                </tr>
                                <tr>
                                    <td class="p-[15px] font-medium text-bodycolor border border-[#00000020]">Coupon</td>
                                    <td class="p-[15px] font-medium text-bodycolor border border-[#00000020]">$28.00</td>
                                </tr>
                                <tr>
                                    <td class="p-[15px] font-medium text-bodycolor border border-[#00000020]">Total</td>
                                    <td class="p-[15px] font-medium text-bodycolor border border-[#00000020]">$506.00</td>
                                </tr>
                            </tbody>
                        </table>
                        <h4 class="widget-title xl:mb-[30px] mb-5 pb-3 relative">Payment Method</h4>
                        <div class="mb-5">
                            <input type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Name on Card">
                        </div>
                        <div class="form-group mb-5 inline-block w-full">
                            <select class="form-select nice-select after:border-black2 after:h-2 after:w-2 after:right-5 after:top-[60%]">
                        ...
                        <div class="form-group mb-5">
                            <input name="dzOther[CreditCardNumber]" type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Credit Card Number">
                        </div>
                        <div class="form-group mb-5">
                            <input name="dzOther[CardVerificationNumber]" type="text" class="h-[50px] py-[10px] px-5 w-full text-[15px] rounded-[6px] placeholder:text-[#666666] focus:border-primary duration-500" placeholder="Card Verification Number">
                        </div>
                        <div class="form-group">
                            <button class="btn bg-[#F3F3F3] gap-[10px] mb-4 shadow-none duration-700 btn-hover-2 btn-gray hover:bg-primary" type="submit" value="submit" name="submit">Place Order Now </button>
                        </div>
                    </form>
                </div>
            </div>
