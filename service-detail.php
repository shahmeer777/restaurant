...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/service-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:34 GMT -->
<head>	
    ...
    <section class="bg-[url('../images/banner/bnr2.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] overflow-hidden lg:h-[450px] md:h-[400px] h-[320px] bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Services Detail</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] font-normal pl-2 active">Services Detail</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
			...
			<div class="container">
				<div class="row">
					<div class="lg:w-1/3 w-full px-[15px] lg:order-1 order-2">
						<aside class="lg:sticky lg:pr-5 pb-[1px]">
							<div class="mb-[50px]">
							...
							<div class="mb-[50px]">
								...
								<div class="widget-post-bx style-1">
									<div class="widget-post bg-transparent flex items-center rounded-[10px] mb-[30px] clearfix">
										<div class="dz-media rounded-[10px] mr-[15px] w-[100px] min-w-[100px] h-[100px] overflow-hidden"> 
											<img src="assets/images/blog/recent-blog/pic4.jpg" alt="/">
										</div>
										<div class="dz-info relative">
											<div class="dz-meta">
												<ul class="px-[-10px]">
													<li class="text-[#1F1F1F] text-sm font-normal leading-[30px] mr-[25px] relative inline-block">
														<a href="javascript:void(0);" class="text-[#1F1F1F]">STANDARD</a>
													</li>
													<li class="date text-[#1F1F1F] text-sm font-medium leading-[30px] mx-[10px] relative inline-block">
														<a href="javascript:void(0);" class="text-[#666666]">Dec 10, 2024</a>
													</li>
												</ul>
											</div>
											<h6 class="text-base"><a href="blog-standard.html">Come Dine with Us!</a></h6>
										</div>
									</div>
								</div>
								<div class="widget-post-bx style-1">
										...
										<div class="dz-info relative">
											<div class="dz-meta">
												<ul class="px-[-10px]">
													...
													<li class="date text-[#1F1F1F] text-sm font-medium leading-[30px] mx-[10px]  relative inline-block">
														<a href="javascript:void(0);" class="text-[#666666]">May 12, 2024</a>
													</li>
												</ul>
											</div>
											<h6 class="text-base"><a href="blog-standard.html">Take a Bite Out of Life</a></h6>
										</div>
									</div>
								</div>
							</div>
							<div class="mb-[50px] widget_categories">
								...
								<ul>
									<li class="cat-item text-right table w-full py-[10px] pl-5 leading-[1.3] relative"><a href="blog-standard.html" class="text-bodycolor text-[15px] font-medium float-left text-left">All Services</a></li>
									<li class="cat-item text-right table w-full py-[10px] pl-5 leading-[1.3] relative"><a href="blog-standard.html" class="text-bodycolor text-[15px] font-medium float-left text-left">Water</a></li>                       
									<li class="cat-item text-right table w-full py-[10px] pl-5 leading-[1.3] relative"><a href="blog-standard.html" class="text-bodycolor text-[15px] font-medium float-left text-left">Residental Cleaning</a></li>
									...
									<li class="cat-item text-right table w-full py-[10px] pl-5 leading-[1.3] relative"><a href="blog-standard.html" class="text-bodycolor text-[15px] font-medium float-left text-left">Free Support</a></li> 
								</ul>
							</div>
						</aside>
					</div>
					<div class="lg:w-4/6 w-full px-[15px] lg:order-2 order-1 mb-[30px]">
						<div class=".dz-card blog-half dz-card sidebar mb-0">
							<div class="dz-media rounded-[10px] overflow-hidden">
								<img src="assets/images/blog/detail/pic2.jpg" alt="/" class="w-full h-auto">
							</div>
							<div class="dz-info pt-[25px]">
								<h2 class="lg:text-4xl md:text-3xl text-[1.75rem] mb-2 font-semibold">Delivery Services in Today's World</h2>
								<div class="dz-meta mb-5">
									<ul>
                                        <li class="dz-user">
                                            <a href="javascript:void(0);" class="text-black2"><i class="fa-solid fa-user text-base text-primary mr-[5px] relative top-0 scale-[1.2]"></i>
                                            By <span class="text-primary">RK Gupta</span></a>
                                        </li>
                                        <li class="dz-comment">
                                            <a href="javascript:void(0);" class="text-black2"><i class="fa-solid fa-message text-base text-primary mr-[5px] relative top-0 scale-[1.2]"></i>
                                            10 Comments</a>
                                        </li>
                                    </ul>
								</div>
								<div class="dz-post-text style-1">
									<p class="mb-[10px] text-base">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
								...
								<blockquote class="wp-block-quote style-1 text-primary xl:pt-[35px] md:pt-[25px] md:pr-[32px] md:pb-5 md:pl-[100px] p-5 shadow-[0px_15px_50px_rgba(34,34,34,0.15)] mt-[22px] mb-5 rounded-[10px] relative">
									<i class="flaticon-right-quote quotes absolute right-auto left-[25px] bottom-auto top-[25px] text-[52px] rotate-180 text-primary md:block hidden"></i>
									<p class="2xl:text-[22px] md:text-lg text-base xl:leading-[35px] leading-[22px] text-black2 mb-6">Fragment collings mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat,</p>
