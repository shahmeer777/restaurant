...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/team-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:33 GMT -->
<head>	
    ...
    <section class="bg-[url('../images/banner/bnr4.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Team Detail</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] pl-2 font-normal active">Team Detail</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
			...
			<div class="container">
				<div class="row">
					<div class="w-full px-[15px]">
						<div class="team-detail relative md:flex block items-center overflow-hidden xl:mb-[55px] lg:mb-10 mb-5">
							<div class="dz-media rounded-[10px] lg:w-[500px] md:w-[250px] w-full lg:min-w-[500px] md:min-w-[250px] min-w-full relative overflow-hidden">
								<img src="assets/images/team/detail/pic1.jpg" alt="/" class="lg:h-auto md:h-[350px] h-full rounded-[10px]">
							</div>
							<div class="dz-info w-full lg:ml-[50px] md:ml-[30px] mb-0 md:mt-0 mt-[30px]">
								<div class="head pb-[18px] mb-[15px] border-b-2 border-[#C6C6C6]">
									<h2 class="lg:mb-2 mb-0 xl:text-[50px] lg:text-[35px] text-[25px] font-semibold">John Doe</h2>
									<span class="sub-title text-primary text-lg font-normal">Restaurant Chef</span>
								</div>
								<p class="xl:text-lg lg:text-[15px] text-sm xl:w-[580px] w-full mb-5">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
								<ul class="team-info mb-[18px]">
									<li class="xl:text-lg text-base mb-2.5 font-normal text-bodycolor"><strong class="mr-[15px] font-normal text-black2">Responsibility:</strong>Senior Chef</li>
									<li class="xl:text-lg text-base mb-2.5 font-normal text-bodycolor"><strong class="mr-[15px] font-normal text-black2">Experience:</strong>10 Year</li>
									<li class="xl:text-lg text-base mb-2.5 font-normal text-bodycolor"><strong class="mr-[15px] font-normal text-black2">Email:</strong>Example@gmail.com</li>
									<li class="xl:text-lg text-base mb-2.5 font-normal text-bodycolor"><strong class="mr-[15px] font-normal text-black2">Phone:</strong>+22 33 56 7675 8939</li>
								</ul>
								<div class="social-icon">
									<ul class="mr-[-20px] ml-[-5px]">
										<li class="inline-block px-[5px] mr-5"><a target="_blank" class="text-bodycolor lg:text-xl text-base" href="https://www.facebook.com/">
											<i class="fab fa-facebook-f"></i>
										</a></li>
										<li class="inline-block px-[5px] mr-5"><a target="_blank" class="text-bodycolor lg:text-xl text-base" href="https://twitter.com/">	
											<i class="fab fa-twitter"></i>
										</a></li>
										<li class="inline-block px-[5px] mr-5"><a target="_blank" class="text-bodycolor lg:text-xl text-base" href="https://www.youtube.com/">
											<i class="fa-brands fa-youtube"></i>
										</a></li>
										<li class="inline-block px-[5px] mr-5"><a target="_blank" class="text-bodycolor lg:text-xl text-base" href="https://www.instagram.com/">
											<i class="fab fa-instagram"></i>
										</a></li>
										<li class="inline-block px-[5px] mr-5"><a target="_blank" class="text-bodycolor lg:text-xl text-base" href="https://www.linkedin.com/feed/">
						...
						<div class="team-bio mb-[55px]">
							<h4 class="mb-2.5">Biography</h4>
						...
						<div class="row">
							<div class="xl:w-5/12 lg:w-1/2 mb-2.5 px-[15px]">
								<h4 class="mb-[15px]">Signature Dish</h4>
								<ul class="dish-gallery flex flex-wrap pl-0 mx-[-10px]">
									<li class="w-1/2 px-[10px] mb-5">
										<a href="product-detail.html">
											<div class="gallery-box-1 relative overflow-hidden rounded-[5px]">
												<img src="assets/images/gallery/grid5/pic1.jpg" alt="/" class="w-full min-w-full md:h-[150px] h-[120px]">
												<span class="absolute bottom-[5px] left-3 text-lg font-medium text-white z-[1]">Sweet Cake</span>
											</div>
										</a>
									</li>
									<li class="w-1/2 px-[10px] mb-5">
										<a href="product-detail.html">
											<div class="gallery-box-1 relative overflow-hidden rounded-[5px]">
												<img src="assets/images/gallery/grid5/pic5.jpg" alt="/" class="w-full min-w-full md:h-[150px] h-[120px]">
												<span class="absolute bottom-[5px] left-3 text-lg font-medium text-white z-[1]">Chicken</span>
											</div>
										</a>
									</li>
									<li class="w-1/2 px-[10px] mb-5">
										<a href="product-detail.html">
											<div class="gallery-box-1 relative overflow-hidden rounded-[5px]">
												<img src="assets/images/gallery/grid5/pic7.jpg" alt="/" class="w-full min-w-full md:h-[150px] h-[120px]">
												<span class="absolute bottom-[5px] left-3 text-lg font-medium text-white z-[1]">Salad</span>
											</div>
										</a>
									</li>
									<li class="w-1/2 px-[10px] mb-5">
										<a href="product-detail.html">
											<div class="gallery-box-1 relative overflow-hidden rounded-[5px]">
												<img src="assets/images/gallery/grid5/pic4.jpg" alt="/" class="w-full min-w-full md:h-[150px] h-[120px]">
												<span class="absolute bottom-[5px] left-3 text-lg font-medium text-white z-[1]">Burger</span>
											</div>
										</a>
									</li>
								</ul>
							</div>
							<div class="xl:w-7/12 lg:w-1/2 w-full mb-[30px] px-[15px]">
								<div class="team-skills">
									<h4 class="mb-2.5">Professional Skills</h4>
									<p class="mb-[15px] xl:w-[480px] w-full text-base">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
									<div class="progress-bx style-1 relative overflow-hidden">
										<h6 class="progress-label mb-[15px] font-medium tracking-[0.02em]">Skills
											<span class="pull-end absolute right-0">60%</span>
										</h6>
										<div class="progress primary rounded-md m-b20 h-[3px] bg-[#D0D0D0] mb-[30px] overflow-visible">
											<div class="progress-bar rounded-md bg-primary flex flex-col justify-center overflow-hidden h-full" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width:60%">
											</div>
										</div>
									</div>
									<div class="progress-bx style-1 relative overflow-hidden">
										<h6 class="progress-label mb-[15px] font-medium tracking-[0.02em]">Signature Dishes
											<span class="pull-end absolute right-0">85%</span>
										</h6>
										<div class="progress primary rounded-md m-b20 h-[3px] bg-[#D0D0D0] mb-[30px] overflow-visible">
											<div class="progress-bar rounded-md bg-primary flex flex-col justify-center overflow-hidden h-full" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width:85%">
											</div>
										</div>
									</div>
									<div class="progress-bx style-1 relative overflow-hidden">
										<h6 class="progress-label mb-[15px] font-medium tracking-[0.02em]">Customer Satisfied
											<span class="pull-end absolute right-0">95%</span>
										</h6>
										<div class="progress primary rounded-md m-b20 h-[3px] bg-[#D0D0D0] mb-[30px] overflow-visible">
											<div class="progress-bar rounded-md bg-primary flex flex-col justify-center overflow-hidden h-full" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100" style="width:95%">
											</div>
										</div>
									</div>
									<div class="progress-bx style-1 relative overflow-hidden">
										<h6 class="progress-label mb-[15px] font-medium tracking-[0.02em]">Communication Skills
											<span class="pull-end absolute right-0">75%</span>
										</h6>
										<div class="progress primary rounded-md m-b20 h-[3px] bg-[#D0D0D0] mb-[30px] overflow-visible">
											<div class="progress-bar rounded-md bg-primary flex flex-col justify-center overflow-hidden h-full" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width:75%">
											</div>
										</div>
									</div>
								</div>
