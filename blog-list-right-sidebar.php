...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/blog-list-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:49 GMT -->
<head>	
...
<div class="progress-wrap">
    ...
    <!-- Banner  -->
    <section class="bg-[url('../images/banner/bnr2.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] overflow-hidden lg:h-[450px] md:h-[400px] h-[320px] bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Blog List Right Sidebar</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] font-normal pl-2 active">Blog List Right Sidebar</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
    ...
    <!-- Blog Section -->
		<section class="lg:pt-[100px] sm:pt-[70px] pt-[50px] lg:pb-[70px] sm:pb-10 pb-5">
			<div class="container">
				<div class="row">
                    <div class="lg:w-4/6 w-full px-[15px] lg:order-1 order-2 mb-[30px]">
					...
					<div class="lg:w-1/3 w-full px-[15px] lg:order-2 order-1">
						<aside class="lg:sticky pl-5 max-xl:pl-0 pb-[1px] top-0">
							<div class="mb-[50px]">
			...
			<div class="footer-bottom relative py-5 border-t border-[#ffffff1a]">
				<div class="row">
					<div class="md:w-1/2 w-full md:text-left text-center px-[15px]">
						 btn-hover-2<p class="text-sm text-[#999999]">Copyright 2024 All rights reserved.</p>
					</div>
