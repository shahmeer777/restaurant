...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/shop-wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:41 GMT -->
<head>	
...
<body id="bg" class="box-border m-0 selection:bg-primary selection:text-white font-poppins">
    ...
    <section class="bg-[url('../images/banner/bnr5.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Shop Wishlist</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] font-normal pl-2 active">Shop Wishlist</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
	...
	<!-- Wishlist Section -->
	<section class="lg:pt-[100px] sm:pt-[70px] pt-[50px] lg:pb-[100px] sm:pb-10 pb-5 relative bg-white overflow-x-auto">
		<div class="container">
			<div class="row">
						...
						<table class="border border-[#00000020] overflow-x-auto align-middle w-full">
							<thead class="align-bottom">
								<tr class="border-b border-[#00000020]">
									<th class="text-left bg-[#222] p-[15px] text-base font-semibold text-white">Product</th>
									<th class="text-left bg-[#222] p-[15px] text-base font-semibold text-white">Product Name</th>
									<th class="text-left bg-[#222] p-[15px] text-base font-semibold text-white">Unit Price</th>
									<th class="text-left bg-[#222] p-[15px] text-base font-semibold text-white">Add to cart </th>
									<th class="text-right bg-[#222] p-[15px] text-base font-semibold text-white">Close</th>
								</tr>
							</thead>
							<tbody>
								<tr class="border-b border-[#00000020]">
									<td class="p-[15px] font-medium product-item-img"><img src="assets/images/gallery/small/pic1.jpg" alt="/" class="w-[100px] rounded-md"></td>
									<td class="p-[15px] font-medium text-bodycolor">Cheese Pizza</td>
									<td class="p-[15px] font-medium text-bodycolor">$35.00</td>
									<td class="p-[15px] font-medium product-item-totle"><a href="shop-cart.html" class="btn bg-[#f3f3f3] shadow-none btn-hover-2 btn-gray hover:bg-primary">Add To Cart</a></td>
									<td class="p-[15px] font-medium text-right">
										<a href="javascript:void(0);" class="bg-danger text-white w-[40px] h-[40px] leading-[40px] rounded-md inline-block text-center">
											<i class="fa fa-close"></i>
										</a>
									</td>
								</tr>
								<tr class="border-b border-[#00000020]">
									<td class="p-[15px] font-medium product-item-img"><img src="assets/images/gallery/small/pic2.jpg" alt="/" class="w-[100px] rounded-md"></td>
									<td class="p-[15px] font-medium text-bodycolor">Fried Rice</td>
									<td class="p-[15px] font-medium text-bodycolor">$28.00</td>
									<td class="p-[15px] font-medium product-item-totle"><a href="shop-cart.html" class="btn bg-[#f3f3f3] shadow-none btn-hover-2 btn-gray hover:bg-primary">Add To Cart</a></td>
									<td class="p-[15px] font-medium text-right">
										<a href="javascript:void(0);" class="bg-danger text-white w-[40px] h-[40px] leading-[40px] rounded-md inline-block text-center">
											<i class="fa fa-close"></i>
								...
								<tr class="border-b border-[#00000020]">
									...
									<td class="p-[15px] font-medium text-bodycolor">Green Salad</td>
									<td class="p-[15px] font-medium text-bodycolor">$15.00</td>
									<td class="p-[15px] font-medium product-item-totle"><a href="shop-cart.html" class="btn bg-[#f3f3f3] shadow-none btn-hover-2 btn-gray hover:bg-primary">Add To Cart</a></td>
									<td class="p-[15px] font-medium text-right">
										<a href="javascript:void(0);" class="bg-danger text-white w-[40px] h-[40px] leading-[40px] rounded-md inline-block text-center">
											<i class="fa fa-close"></i>
								...
								<tr class="border-b border-[#00000020]">
									<td class="p-[15px] font-medium product-item-img"><img src="assets/images/gallery/small/pic4.jpg" alt="/" class="w-[100px] rounded-md"></td>
									<td class="p-[15px] font-medium text-bodycolor">Butterfly Pasta</td>
									<td class="p-[15px] font-medium text-bodycolor">$55.00</td>
									<td class="p-[15px] font-medium product-item-totle"><a href="shop-cart.html" class="btn bg-[#f3f3f3] shadow-none btn-hover-2 btn-gray hover:bg-primary">Add To Cart</a></td>
									<td class="p-[15px] font-medium text-right">
										<a href="javascript:void(0);" class="bg-danger text-white w-[40px] h-[40px] leading-[40px] rounded-md inline-block text-center">
											<i class="fa fa-close"></i>
...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/shop-wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:42 GMT -->
</html>