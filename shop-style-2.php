...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/shop-style-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:41 GMT -->
<head>	
...
<body id="bg" class="box-border m-0 selection:bg-primary selection:text-white font-poppins">
						...
						<li class="sub-menu-down has-mega-menu">
							...
							<ul class="mega-menu sub-menu p-0 left-0 lg:table">
								...
								<li> <a href="javascript:;">Blog List</a>
									<ul class="sub-part lg:mt-[15px]">
										<li><a href="blog-list-2.html">Blog List</a></li>
										<li><a href="blog-list-Left-Sidebar-2.html">Blog List Left Sidebar</a></li>
										<li><a href="blog-list-Right-Sidebar-2.html">Blog List Right Sidebar</a></li>
										<li><a href="blog-both-sidebar-2.html">Blog Both Sidebar</a></li>
									</ul>
								</li>
    ...
    <section class="bg-[url('../images/banner/bnr2.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Shop Style 2</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] pl-2 font-normal active">Shop Style 2</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
					...
					<div class="lg:w-2/3 w-full px-[15px] m-auto">
						<form>
							<div class="input-group relative flex flex-wrap items-stretch z-[1] w-full">
								<input required="required" type="text" class="form-control bg-white py-[25px] sm:pr-[150px] pr-20 pl-[30px] border-none rounded-[10px] lg:h-[80px] h-[60px] w-full shadow-[0px_15px_55px_rgba(34,34,34,0.15)] text-[#666666] text-[15px] outline-none" placeholder="Type Here">
                                <div class="input-group-addon absolute top-[50%] right-[12px] translate-y-[-50%] z-[9]">
                                    <button name="submit" value="submit" type="submit" class="btn btn-primary btn-hover-2 lg:py-[15PX] xl:px-[30px] sm:py-[10px] py-[6px] px-3">
				...
				<div class="row">
						...
						<div class="shop-filter">
							<div class="widget mb-[50px] widget_tag_cloud">
								<div class="flex justify-between">
									...
									<a href="javascript:void(0);" class="btn-close style-1 text-xl font-black text-primary p-0 lg:hidden block"><i class="la la-close font-black"></i></a>
								</div>
								<div class="tagcloud table"> 
									...
									<a href="product-detail.html" class="relative py-[9px] px-[15px] inline-block mr-[10px] mb-[10px] text-sm font-normal leading-[1.4] bg-white rounded-lg text-[#666666] border border-[#2222221a]">Restaurant</a>
							...
							<div class="widget dz-widget_services mb-[50px] dz-widget_services">
								...
								<div class="form-check mb-[15px] block">
									<input class="form-check-input w-5 h-5 rounded border border-[#2222224d] float-left appearance-none" type="checkbox" value="" id="productCheckBox-01">
									<label class="form-check-label ml-[15px] text-[15px] inline-block text-bodycolor" for="productCheckBox-01">
										Pizza
									</label>
								</div>
								<div class="form-check mb-[15px] block">
									<input class="form-check-input w-5 h-5 rounded border border-[#2222224d] float-left appearance-none" type="checkbox" value="" id="productCheckBox-02">
									<label class="form-check-label ml-[15px] text-[15px] inline-block text-bodycolor" for="productCheckBox-02">
										Hamburger
									</label>
								</div>
								<div class="form-check mb-[15px] block">
									<input class="form-check-input w-5 h-5 rounded border border-[#2222224d] float-left appearance-none" type="checkbox" value="" id="productCheckBox-03">
									<label class="form-check-label ml-[15px] text-[15px] inline-block text-bodycolor" for="productCheckBox-03">
										Cold Drink
									</label>
								</div>
								<div class="form-check mb-[15px] block">
									<input class="form-check-input w-5 h-5 rounded border border-[#2222224d] float-left appearance-none" type="checkbox" value="" id="productCheckBox-04">
									<label class="form-check-label ml-[15px] text-[15px] inline-block text-bodycolor" for="productCheckBox-04">
										Sandwich
									</label>
								</div>
								<div class="form-check mb-[15px] block">
									<input class="form-check-input w-5 h-5 rounded border border-[#2222224d] float-left appearance-none" type="checkbox" value="" id="productCheckBox-05">
									<label class="form-check-label ml-[15px] text-[15px] inline-block text-bodycolor" for="productCheckBox-05">
										Muffin
									</label>
								</div>
								<div class="form-check mb-[15px] block">
									<input class="form-check-input w-5 h-5 rounded border border-[#2222224d] float-left appearance-none" type="checkbox" value="" id="productCheckBox-06">
									<label class="form-check-label ml-[15px] text-[15px] inline-block text-bodycolor" for="productCheckBox-06">
										Burrito
									</label>
								</div>
								<div class="form-check mb-[15px] block">
									<input class="form-check-input w-5 h-5 rounded border border-[#2222224d] float-left appearance-none" type="checkbox" value="" id="productCheckBox-07">
									<label class="form-check-label ml-[15px] text-[15px] inline-block text-bodycolor" for="productCheckBox-07">
										Taco
									</label>
								</div>
								<div class="form-check mb-[15px] block">
									<input class="form-check-input w-5 h-5 rounded border border-[#2222224d] float-left appearance-none" type="checkbox" value="" id="productCheckBox-08">
									<label class="form-check-label ml-[15px] text-[15px] inline-block text-bodycolor" for="productCheckBox-08">
										Hot Dog
									</label>
								</div>
							</div>
					...
					<div class="lg:w-3/4 w-full px-[15px] lg:order-2 order-1">
						<div class="flex justify-between items-center">
							<h5 class="md:mb-4 lg:mb-6 mb-5 lg:block hidden">Search Results</h5>
							<strong class="filter-item-show mb-5 text-bodycolor font-medium">Search: 51,740 items</strong>
							<a href="#offcanvasFilter" id="filter-button2" class="btn btn-primary filter-btn lg:hidden block mb-[15px] py-[5px] px-[18px] text-white">
								Filter
							</a>
						</div>
                        <ul class="row">
                            <li class="lg:w-1/3 md:w-1/2 w-full px-[15px] mb-[30px] All drink sweet salad">
                            ...
                            <li class="lg:w-1/3 md:w-1/2	w-full px-[15px] mb-[30px] All pizza sweet">
                                <div class="dz-img-box7 rounded-[10px] bg-white text-center relative h-full duration-200 overflow-hidden z-[1] shadow-[0px_15px_55px_rgba(34,34,34,0.15)]">
                                    <div class="dz-media relative overflow-hidden">
                            ...
                            <li class="lg:w-1/3 md:w-1/2	w-full px-[15px] mb-[30px] All salad spicy">
                                <div class="dz-img-box7 rounded-[10px] bg-white text-center relative h-full duration-200 overflow-hidden z-[1] shadow-[0px_15px_55px_rgba(34,34,34,0.15)]">
                                    <div class="dz-media relative overflow-hidden">
                            ...
                            <li class="lg:w-1/3 md:w-1/2	w-full px-[15px] mb-[30px] All drink spicy sweet">
                                <div class="dz-img-box7 rounded-[10px] bg-white text-center relative h-full duration-200 overflow-hidden z-[1] shadow-[0px_15px_55px_rgba(34,34,34,0.15)]">
                                    <div class="dz-media relative overflow-hidden">
                            ...
                            <li class="lg:w-1/3 md:w-1/2	w-full px-[15px] mb-[30px] All burger">
                                <div class="dz-img-box7 rounded-[10px] bg-white text-center relative h-full duration-200 overflow-hidden z-[1] shadow-[0px_15px_55px_rgba(34,34,34,0.15)]">
                                    <div class="dz-media relative overflow-hidden">
                            ...
                            <li class="lg:w-1/3 md:w-1/2	w-full px-[15px] mb-[30px] All pizza burger">
                                <div class="dz-img-box7 rounded-[10px] bg-white text-center relative h-full duration-200 overflow-hidden z-[1] shadow-[0px_15px_55px_rgba(34,34,34,0.15)]">
                                    <div class="dz-media relative overflow-hidden">
                            ...
                            <li class="lg:w-1/3 md:w-1/2 w-full px-[15px] mb-[30px] All pizza burger">
                                <div class="dz-img-box7 rounded-[10px] bg-white text-center relative h-full duration-200 overflow-hidden z-[1] shadow-[0px_15px_55px_rgba(34,34,34,0.15)]">
                                    ...
                                    <div class="dz-content flex flex-col lg:py-[25px] py-5 lg:px-5 px-[15px]">
                                        <h5 class="title text-black2 mb-2"><a href="product-detail.html">Spicy Burger</a></h5>
                                        <p class="mb-[10px] text-sm">It is a long established fact that a reader will be distracted by the readable.</p>
                                        <span class="price text-2xl font-semibold leading-[1.1]">$12.20</span>
                                    </div>
                                </div>
                            ...
                            <li class="lg:w-1/3 md:w-1/2	w-full px-[15px] mb-[30px] All pizza burger">
                                <div class="dz-img-box7 rounded-[10px] bg-white text-center relative h-full duration-200 overflow-hidden z-[1] shadow-[0px_15px_55px_rgba(34,34,34,0.15)]">
                                    ...
                                    <div class="dz-content flex flex-col lg:py-[25px] py-5 lg:px-5 px-[15px]">
                                        <h5 class="title text-black2 mb-2"><a href="product-detail.html">Cheese Burger</a></h5>
                                        <p class="mb-[10px] text-sm">It is a long established fact that a reader will be distracted by the readable.</p>
                                        <span class="price text-2xl font-semibold leading-[1.1]">$12.20</span>
                                    </div>
                                </div>
	...
	<!-- Modal -->
	<div class="modal modal-detail z-[10000] fixed top-[5%] left-[25%] duration-500" style="display: none;">
		<div class="modal-dialog max-w-[970px] relative w-auto mx-auto duration-500">
			<div class="modal-content relative flex flex-col rounded-2xl w-full bg-white">
				<div class="modal-body product-detail flex rounded-md relative p-[6px]">
					<div class="detail-media rounded-[10px] overflow-hidden lg:min-w-[365px] lg:w-[365px] w-full min-w-full">
						<img src="assets/images/modal/pic1.jpg" alt="/" class="h-full w-full object-cover">
					</div>
					<div class="detail-info py-[25px] pr-5 pl-[35px] relative">
						<span class="badge p-[2px] font-medium text-sm leading-5 text-[#666666] flex items-center rounded-[10px]">
						...
						<div class="dz-head">
							<h4 class="mb-2">Double Patty Veg Burger</h4>
							<div class="rating text-sm leading-[21px]">
								<i class="fa-solid fa-star text-[var(--secondary-dark)]"></i> <span class="text-bodycolor"><strong class="font-medium">4.5</strong> - 20 Reviews</span>
							</div>
						</div>
						<p class="text-[15px] mt-5 mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry</p>
						<ul class="detail-list flex my-[25px]">
							<li class="mr-[45px] text-[15px] font-medium leading-[22px] text-bodycolor">Price <span class="text-primary flex text-xl font-semibold leading-[30px] mt-[5px]">$20.00</span></li>
						...
						<h6 class="mb-2">Add On</h6>
						<ul class="add-product flex flex-wrap mx-[-5px] mb-[30px] w-full">
							<li class="p-[5px] w-[50%]"><div class="mini-modal inline-flex p-[10px] w-full rounded-[10px] items-center border border-[#2222221a]">
									<div class="dz-media w-[45px] min-w-[45px] h-[45px] rounded-md relative overflow-hidden">
										<img src="assets/images/modal/mini/pic1.jpg" alt="/" class="w-full h-auto">
									</div>
									<div class="dz-content ml-[15px] flex justify-between w-full">
										<p class="font-medium text-black2 text-base">French Frise</p>
										<div class="form-check search-content block">
											<input class="form-check-input appearance-none rounded-[0.5em] w-6 h-6 border-2 border-primary" type="checkbox" value="">
										</div>
									</div>
								</div>
							</li>
							<li class="p-[5px] w-[50%]"><div class="mini-modal inline-flex p-[10px] w-full rounded-[10px] items-center border border-[#2222221a]">
									<div class="dz-media w-[45px] min-w-[45px] h-[45px] rounded-md relative overflow-hidden">
										<img src="assets/images/modal/mini/pic2.jpg" alt="/" class="w-full h-auto">
									</div>
									<div class="dz-content ml-[15px] flex justify-between w-full">
										<p class="font-medium text-black2 text-base">Extra Cheese</p>
										<div class="form-check search-content block">
											<input class="form-check-input appearance-none rounded-[0.5em] w-6 h-6 border-2 border-primary" type="checkbox" value="">
										</div>
									</div>
							...
							<li class="p-[5px] w-[50%]"><div class="mini-modal inline-flex p-[10px] w-full rounded-[10px] items-center border border-[#2222221a]">
									<div class="dz-media w-[45px] min-w-[45px] h-[45px] rounded-md relative overflow-hidden">
										<img src="assets/images/modal/mini/pic3.jpg" alt="/" class="w-full h-auto">
									</div>
									<div class="dz-content ml-[15px] flex justify-between w-full">
										<p class="font-medium text-black2 text-base">Coca Cola</p>
										<div class="form-check search-content block">
											<input class="form-check-input appearance-none rounded-[0.5em] w-6 h-6 border-2 border-primary" type="checkbox" value="">
										</div>
									</div>
							...
							<li class="p-[5px] w-[50%]"><div class="mini-modal inline-flex p-[10px] w-full rounded-[10px] items-center border border-[#2222221a]">
									<div class="dz-media w-[45px] min-w-[45px] h-[45px] rounded-md relative overflow-hidden">
										<img src="assets/images/modal/mini/pic4.jpg" alt="/" class="w-full h-auto">
									</div>
									<div class="dz-content ml-[15px] flex justify-between w-full">
										<p class="font-medium text-black2 text-base">Choco Lava</p>
										<div class="form-check search-content block">
											<input class="form-check-input appearance-none rounded-[0.5em] w-6 h-6 border-2 border-primary" type="checkbox" value="">
										</div>
									</div>
						...
						<ul class="modal-btn-group flex mx-[-7px]">
							<li class="mx-[7px]"><a href="shop-cart.html" class="btn shadow-none btn-primary btn-hover-1"><span>Add To Cart <i class="flaticon-shopping-bag-1 text-xl ml-[10px] inline-flex"></i></span></a></li>
							<li class="mx-[7px]">
								<a href="shop-checkout.html" class="btn shadow-none btn-outline-secondary btn-hover-1">
									<span>Buy Now <i class="flaticon-shopping-cart text-xl ml-[10px] inline-flex"></i>
									</span>
								</a>
							</li>
						</ul>
