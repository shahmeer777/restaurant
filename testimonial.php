...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/testimonial.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:33 GMT -->
<head>	
    ...
    <section class="bg-[url('../images/banner/bnr5.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Testimonial</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] pl-2 font-normal active">Customer's Comment</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
				...
				<div class="row loadmore-content">
					<div class="w-full px-[15px] lg:mb-[60px] mb-[30px]">
						<div class="testimonial-2 flex lg:flex-row flex-col bg-white relative">
							<div class="dz-media rounded-lg xl:w-[570px] xl:min-w-[570px] lg:w-[450px] lg:min-w-[450px] w-full relative overflow-hidden">
								<img src="assets/images/testimonial/large/pic1.jpg" alt="/" class="max-xl:h-full object-cover">
							</div>
					...
					<div class="w-full px-[15px] lg:mb-[60px] mb-[30px]">
						<div class="testimonial-2 flex lg:flex-row flex-col-reverse bg-white relative">
                            ...
                            <div class="dz-media rounded-lg xl:w-[570px] xl:min-w-[570px] lg:w-[450px] lg:min-w-[450px] w-full relative overflow-hidden">
								<img src="assets/images/testimonial/large/pic2.jpg" alt="/" class="max-xl:h-full object-cover">
							</div>
						</div>
					</div>
					<div class="w-full px-[15px] lg:mb-[60px] mb-[30px]">
						<div class="testimonial-2 flex lg:flex-row flex-col bg-white relative">
							<div class="dz-media rounded-lg xl:w-[570px] xl:min-w-[570px] lg:w-[450px] lg:min-w-[450px] w-full relative overflow-hidden">
								<img src="assets/images/testimonial/large/pic3.jpg" alt="/" class="max-xl:h-full object-cover">
							</div>
							<div class="testimonial-1 lg:pt-5 lg:pb-[30px] lg:pl-[30px] py-5 relative w-full flex flex-col">
								<div class="testimonial-text relative my-[15px] text-base">
									<p class="xl:text-[18px] text-base leading-[32px] font-medium text-[#222222]">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/testimonial.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:34 GMT -->
</html>