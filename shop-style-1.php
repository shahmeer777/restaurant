...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/shop-style-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:41 GMT -->
<head>	
...
<body id="bg" class="box-border m-0 selection:bg-primary selection:text-white font-poppins">
    ...
    <section class="bg-[url('../images/banner/bnr1.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Shop Style 1</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] pl-2 font-normal active">Shop Style 1</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
					...
					<div class="lg:w-2/3 w-full px-[15px] m-auto">
						<form>
							<div class="input-group relative flex flex-wrap items-stretch z-[1] w-full">
								<input required="required" type="text" class="form-control bg-white py-[25px] pl-[30px] sm:pr-[150px] pr-20 border-none rounded-[10px] lg:h-[80px] h-[60px] w-full shadow-[0px_15px_55px_rgba(34,34,34,0.15)] text-[#666666] text-[15px] outline-none" placeholder="Type Here">
					...
					<div class="lg:w-3/4 w-full px-[15px] lg:order-2 order-1 mb-[30px]">
						...
						<div class="dz-shop-card style-1 flex border border-[#0000001a] rounded-[10px] mb-5 overflow-hidden duration-500 hover:border-transparent hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] relative">
							<div class="dz-media w-[100px] min-w-[100px]">
								<img src="assets/images/shop/pic1.jpg" alt="/" class="h-full">
							</div>
							<div class="dz-content sm:p-5 p-2 flex flex-col w-full">
								<div class="dz-head mb-4 flex items-center justify-between">
									<h6 class="dz-name mb-0 flex items-center text-base">
										...
										<a href="javascript:void(0);" class="menuDetailModal">Double Patty Burger</a>
									</h6>
								...
								<div class="dz-body sm:flex block justify-between">
									<ul class="dz-meta flex mx-[-10px]">
										<li class="leading-[21px] mx-[10px] text-sm text-[#727272]">By <span class="text-primary font-medium"> Burger Farm</span></li>
										<li class="leading-[21px] mx-[10px] text-sm text-[#727272]"><i class="flaticon-scooter mr-1 text-xl text-primary"></i> 30 min</li>
									</ul>
						...
						<div class="dz-shop-card style-1 flex border border-[#0000001a] rounded-[10px] mb-5 overflow-hidden duration-500 hover:border-transparent hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] relative">
							<div class="dz-media w-[100px] min-w-[100px]">
								<img src="assets/images/shop/pic2.jpg" alt="/" class="h-full">
							</div>
							<div class="dz-content sm:p-5 p-2 flex flex-col w-full">
								<div class="dz-head mb-4 flex items-center justify-between">
									<h6 class="dz-name mb-0 flex items-center text-base">
										...
										<a href="javascript:void(0);" class="menuDetailModal">Chicken Patty Burger</a>
									</h6>
									<div class="rate bg-[#FE9F10] text-white rounded-[5px] py-[2px] px-[5px] font-medium text-[13px] leading-[18px] inline-block sm:static absolute bottom-[10px] right-3">
										<i class="fa-solid fa-star"></i> 4.5
									</div>
								...
								<div class="dz-body sm:flex block justify-between">
									<ul class="dz-meta flex mx-[-10px]">
										<li class="leading-[21px] mx-[10px] text-sm text-[#727272]">By <span class="text-primary font-medium"> Burger Farm</span></li>
										<li class="leading-[21px] mx-[10px] text-sm text-[#727272]"><i class="flaticon-scooter mr-1 text-xl text-primary"></i> 20 min</li>
									</ul>
						...
						<div class="dz-shop-card style-1 flex border border-[#0000001a] rounded-[10px] mb-5 overflow-hidden duration-500 hover:border-transparent hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] relative">
							<div class="dz-media w-[100px] min-w-[100px]">
								<img src="assets/images/shop/pic3.jpg" alt="/" class="h-full">
							</div>
							<div class="dz-content sm:p-5 p-2 flex flex-col w-full">
								<div class="dz-head mb-4 flex items-center justify-between">
									<h6 class="dz-name mb-0 flex items-center text-base">
										...
										<a href="javascript:void(0);" class="menuDetailModal">Veg Cripsy Burger</a>
									</h6>
									<div class="rate bg-[#FE9F10] text-white rounded-[5px] py-[2px] px-[5px] font-medium text-[13px] leading-[18px] inline-block sm:static absolute bottom-[10px] right-3">
										<i class="fa-solid fa-star"></i> 4.5
									</div>
								...
								<div class="dz-body sm:flex block justify-between">
									<ul class="dz-meta flex mx-[-10px]">
										<li class="leading-[21px] mx-[10px] text-sm text-[#727272]">By <span class="text-primary font-medium"> Burger Farm</span></li>
										<li class="leading-[21px] mx-[10px] text-sm text-[#727272]"><i class="flaticon-scooter mr-1 text-xl text-primary"></i> 40 min</li>
									</ul>
						...
						<div class="dz-shop-card style-1 flex border border-[#0000001a] rounded-[10px] mb-5 overflow-hidden duration-500 hover:border-transparent hover:shadow-[0px_15px_55px_rgba(34,34,34,0.15)] relative">
							<div class="dz-media w-[100px] min-w-[100px]">
								<img src="assets/images/shop/pic4.jpg" alt="/" class="h-full">
							</div>
							<div class="dz-content sm:p-5 p-2 flex flex-col w-full">
								<div class="dz-head mb-4 flex items-center justify-between">
									<h6 class="dz-name mb-0 flex items-center text-base">
										...
										<a href="javascript:void(0);" class="menuDetailModal">Aloo Tikki Burger</a>
									</h6>
									<div class="rate bg-[#FE9F10] text-white rounded-[5px] py-[2px] px-[5px] font-medium text-[13px] leading-[18px] inline-block sm:static absolute bottom-[10px] right-3">
										<i class="fa-solid fa-star"></i> 4.5
									</div>
								...
								<div class="dz-body sm:flex block justify-between">
									<ul class="dz-meta flex mx-[-10px]">
										<li class="leading-[21px] mx-[10px] text-sm text-[#727272]">By <span class="text-primary font-medium"> Burger Farm</span></li>
										<li class="leading-[21px] mx-[10px] text-sm text-[#727272]"><i class="flaticon-scooter mr-1 text-xl text-primary"></i> 15 min</li>
									</ul>
							...
							<div class="dz-content sm:p-5 p-2 flex flex-col w-full">
								<div class="dz-head mb-4 flex items-center justify-between">
									<h6 class="dz-name mb-0 flex items-center text-base">
										...
										<a href="javascript:void(0);" class="menuDetailModal">Pure Veg Burger</a>
									</h6>
									<div class="rate bg-[#FE9F10] text-white rounded-[5px] py-[2px] px-[5px] font-medium text-[13px] leading-[18px] inline-block sm:static absolute bottom-[10px] right-3">
										<i class="fa-solid fa-star"></i> 4.5
									</div>
								...
								<div class="dz-body sm:flex block justify-between">
									<ul class="dz-meta flex mx-[-10px]">
										<li class="leading-[21px] mx-[10px] text-sm text-[#727272]">By <span class="text-primary font-medium"> Burger Farm</span></li>
										<li class="leading-[21px] mx-[10px] text-sm text-[#727272]"><i class="flaticon-scooter mr-1 text-xl text-primary"></i> 55 min</li>
									</ul>
							...
							<div class="dz-content sm:p-5 p-2 flex flex-col w-full">
								<div class="dz-head mb-4 flex items-center justify-between">
									<h6 class="dz-name mb-0 flex items-center text-base">
										...
										<a href="javascript:void(0);" class="menuDetailModal">Chicken Burger</a>
									</h6>
									<div class="rate bg-[#FE9F10] text-white rounded-[5px] py-[2px] px-[5px] font-medium text-[13px] leading-[18px] inline-block sm:static absolute bottom-[10px] right-3">
										<i class="fa-solid fa-star"></i> 4.5
									</div>
								...
								<div class="dz-body sm:flex block justify-between">
									<ul class="dz-meta flex mx-[-10px]">
										<li class="leading-[21px] mx-[10px] text-sm text-[#727272]">By <span class="text-primary font-medium"> Burger Farm</span></li>
										<li class="leading-[21px] mx-[10px] text-sm text-[#727272]"><i class="flaticon-scooter mr-1 text-xl text-primary"></i> 25 min</li>
									</ul>
	...
	<!-- Modal -->
	<div class="modal modal-detail z-[900] fixed lg:top-[25%] top-0 left-0 duration-500 overflow-x-hidden overflow-y-auto w-full h-full" style="display: none;">
		<div class="modal-dialog lg:max-w-[970px] max-w-[750px] relative w-auto duration-500 lg:p-0 sm:p-[15px] p-[10px] sm:m-auto m-2 pointer-events-none">
			<div class="modal-content relative flex flex-col rounded-2xl w-full bg-white pointer-events-auto bg-clip-padding">
				<div class="modal-body product-detail lg:flex block rounded-md relative p-[6px]">
					<div class="detail-media rounded-[10px] overflow-hidden lg:min-w-[365px] lg:w-[365px] w-full min-w-full">
						<img src="assets/images/modal/pic1.jpg" alt="/" class="lg:h-full sm:h-[400px] h-[280px] w-full object-cover">
					</div>
					<div class="detail-info lg:py-[25px] lg:pr-5 lg:pl-[35px] p-[15px] relative">
							...
							<li class="p-[5px] sm:w-[50%] w-full"><div class="mini-modal inline-flex p-[10px] w-full rounded-[10px] items-center border border-[#2222221a]">
									...
									<div class="dz-content ml-[15px] flex justify-between w-full">
										...
										<div class="form-check search-content block">
											<input class="form-check-input appearance-none rounded-md w-6 h-6 border-2 border-primary" type="checkbox" value="">
										</div>
									</div>
								</div>
							</li>
						...
						<ul class="modal-btn-group sm:flex block mx-[-7px]">
							<li class="mx-[7px] lg:mb-0 mb-[10px]"><a href="shop-cart.html" class="btn shadow-none btn-primary btn-hover-1"><span>Add To Cart <i class="flaticon-shopping-bag-1 text-xl ml-[10px] inline-flex"></i></span></a>
							</li>
