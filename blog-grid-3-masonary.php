...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/blog-grid-3-masonary.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:52 GMT -->
<head>	
    ...
    <section class="bg-[url('../images/banner/bnr1.jpg')] bg-fixed  relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] overflow-hidden lg:h-[450px] md:h-[400px] h-[320px] bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Blog Grid 3 Masonry</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] pl-2 font-normal active">Blog Grid 3 Masonry</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
		...
		<section class="content-inner-1 sm:pt-[100px] pt-[50px] lg:pb-[70px] sm:pb-10 pb-5">
			<div class="container clearfix">
				<div id="masonry" class="row" data-masonry='{"percentPosition": true}'>
					<div class="card-container lg:w-2/6 md:w-1/2 w-full px-[15px]">
					...
					<div class="card-container lg:w-2/6 md:w-1/2 w-full px-[15px]">
						<div class="dz-card style-3 dz-card-large blog-half relative min-h-[570px] h-full overflow-hidden rounded-lg flex flex-col mb-[30px]" style="background-image: url(assets/images/blog/large/pic1.jpg)">
							<div class="dz-info p-[30px] z-[1] mt-auto">
                                <h4 class="dz-title mb-[15px]"><a href="blog-standard.html" class="text-white">Exploring the World of Pizza</a></h4>
                                <div class="dz-meta">
                                    <ul>
                                        <li class="dz-date absolute top-[35px] left-[35px] after:hidden py-[10px] px-[15px] block duration-1000 hover:text-primary hover:bg-white">14 Feb 2024</li>
                                        <li class="dz-user mr-[34px]">
					...
					<div class="card-container lg:w-2/6 md:w-1/2 w-full px-[15px]">
						<div class="dz-card rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] bg-white group mb-[30px]">
							<div class="service-swiper swiper">
								...
								<div class="swiper-pagination style-1 inline-block absolute bottom-2.5"></div>
								<div class="service-button-prev btn-prev absolute rounded-full top-[50%] bg-white text-primary hover:bg-primary hover:text-white translate-y-[-50%] duration-500"><i class="icon-arrow-left"></i></div>
								<div class="service-button-next btn-next absolute rounded-full top-[50%] bg-white text-primary hover:bg-primary hover:text-white translate-y-[-50%] duration-500 right-0"><i class="icon-arrow-right"></i></div>
							</div>
							<div class="content flex-col flex p-[30px] max-xl:p-5 relative">
                                <div class="mb-2.5">
                                    <ul class="flex items-center">
					...
					<div class="card-container lg:w-2/6 md:w-1/2 w-full px-[15px]">
						<div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] bg-white group mb-[30px]">
                            <div class="dz-media w-full h-full mb-0 relative overflow-hidden">
                                ...
                                <a class="video video-btn popup-youtube absolute top-[50%] left-[50%] 2xl:w-[60px] md:w-[55px] w-[60px] 2xl:h-[60px] md:h-[55px] h-[60px] bg-primary text-white rounded-full 2xl:text-lg md:text-base text-lg flex items-center justify-center translate-x-[-50%]  translate-y-[-50%] duration-500 hover:scale-125" href="https://www.youtube.com/watch?v=XJb1G9iRoL4">
					...
					<div class="card-container lg:w-2/6 md:w-1/2 w-full px-[15px]">
						<div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] bg-white group mb-[30px]">
                            ...
                            <div class="content flex-col flex p-[30px] max-xl:p-5 relative">
                                ...
                                <h5 class="mb-2">Taste Excitment</h5>
                                <p class="text-base">There are many variations of passages of Lorem Ipsum available, but the majority have.</p>
                                <div>
                                    <a href="blog-standard.html" class="py-3 px-6 text-sm font-medium relative inline-flex items-center justify-center rounded-md mt-[18px]  bg-primary border-primary text-white btn-hover-2">Read More</a>
                                </div>
