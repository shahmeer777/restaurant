...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:29 GMT -->
<head>	
    ...
    <section class="bg-[url('../images/banner/bnr1.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">About Us</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] font-normal active pl-2">About Us</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
    ...
    <section class="lg:pt-[100px] sm:pt-[70px] pt-[50px] overflow-hidden pb-0">
        <div class="container">
            <div class="2xl:mb-[50px] mb-[35px] relative mx-auto text-center">
                <h2 class="font-lobster max-xl:leading-[50px]">We Invite you to Visit Our Restaurant</h2>
                <p class="max-w-[815px] m-auto lg:text-base text-sm lg:leading-[1.6rem]">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>    
            </div>
            <div class="row">
                <div class="w-full px-[15px]">
                    <div class="about-media dz-media relative overflow-hidden rounded-[10px]">
                        <img src="assets/images/background/pic11.jpg" alt="/" class="lg:h-[430px] sm:h-[380px] h-[300px]">
...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:30 GMT -->
</html>