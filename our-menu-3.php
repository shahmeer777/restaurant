...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/our-menu-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:37 GMT -->
<head>	
...
<body id="bg" class="box-border m-0 selection:bg-primary selection:text-white font-poppins">
    ...
    <!-- Banner  -->
    <section class="bg-[url('../images/banner/bnr3.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Our Menu 3</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] font-normal pl-2 active">Our Menu 3</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
    ...
    <!-- Banner End -->
	 ...
	 <!-- our Menu-->
     <section class="content-inner-1 lg:pt-[100px] sm:pt-[70px] pt-[50px] pb-10 relative overflow-hidden">
		<div class="container">
			<div class="row justify-between">
				<div class="xl:w-10/12 lg:w-9/12 w-full px-[15px]">
					<div class="site-filters lg:mb-10 mb-[30px] sm:text-left text-center">
						<ul class="filters style-1">
							<li data-filter=".All" class="btn lg:py-2 lg:px-[15px] p-2 lg:mr-[10px] mr-[5px] duration-500 active">
								<a href="javascript:void(0);" class="flex items-center lg:text-[15px] text-[13px] overflow-hidden"><span class="mb-0"><i class="flaticon-fast-food text-[25px]  lg:mr-[10px] mr-[5px]"></i></span>ALL</a>
							</li>
							<li data-filter=".drink" class="btn lg:py-2 lg:px-[15px] p-2 lg:mr-[10px] mr-[5px]">
								<a href="javascript:void(0);" class="flex items-center lg:text-[15px] text-[13px] overflow-hidden"><span class="mb-0"><i class="flaticon-cocktail text-[25px]  lg:mr-[10px] mr-[5px]"></i></span>COLD DRINK</a>
							</li>
							<li data-filter=".pizza" class="btn lg:py-2 lg:px-[15px] p-2 lg:mr-[10px] mr-[5px]">
								<a href="javascript:void(0);" class="flex items-center lg:text-[15px] text-[13px] overflow-hidden"><span class="mb-0"><i class="flaticon-pizza-slice text-[25px]  lg:mr-[10px] mr-[5px]"></i></span>PIZZA</a>
							</li>
							<li data-filter=".salad" class="btn lg:py-2 lg:px-[15px] p-2 lg:mr-[10px] mr-[5px] duration-500 active">
								<a href="javascript:void(0);" class="flex items-center lg:text-[15px] text-[13px] overflow-hidden"><span class="mb-0"><i class="flaticon-salad text-[25px]  lg:mr-[10px] mr-[5px]"></i></span>SALAD</a>
							</li>
							<li data-filter=".sweet" class="btn lg:py-2 lg:px-[15px] p-2 lg:mr-[10px] mr-[5px] duration-500 active">
								<a href="javascript:void(0);" class="flex items-center lg:text-[15px] text-[13px] overflow-hidden"><span class="mb-0"><i class="flaticon-cupcake text-[25px]  lg:mr-[10px] mr-[5px]"></i></span>SWEETS</a>
							</li>
							<li data-filter=".spicy" class="btn lg:py-2 lg:px-[15px] p-2 lg:mr-[10px] mr-[5px] duration-500 active">
								<a href="javascript:void(0);" class="flex items-center lg:text-[15px] text-[13px] overflow-hidden"><span class="mb-0"><i class="flaticon-chili-pepper text-[25px]  lg:mr-[10px] mr-[5px]"></i></span>SPICY</a>
							</li>
							<li data-filter=".burger" class="btn lg:py-2 lg:px-[15px] p-2 lg:mr-[10px] mr-[5px] duration-500 active">
								<a href="javascript:void(0);" class="flex items-center lg:text-[15px] text-[13px] overflow-hidden"><span class="mb-0"><i class="flaticon-hamburger-1 text-[25px]  lg:mr-[10px] mr-[5px]"></i></span>BURGER</a>
							</li>
						</ul>
					</div>
				</div>
				<div class="xl:w-2/12 lg:w-1/4 w-full px-[15px] lg:text-right lg:block flex justify-between items-center mb-[30px]">
					<strong class="filter-item-show text-bodycolor font-medium lg:hidden block">51,740 items</strong>
					<a href="#offcanvasFilter" id="filter-button" class="btn btn-primary filter-btn btn-hover-2">
						Filter <span><i class="icon-filter ml-[5px] text-xl"></i></span>
					</a>
				</div>
			</div>
			<div class="clearfix">
				<ul id="masonry" class="row dlab-gallery-listing gallery">
					<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] mb-[30px] All drink sweet salad">
						<div class="dz-img-box7 rounded-[10px] bg-white text-center relative h-full duration-200 overflow-hidden z-[1] shadow-[0px_15px_55px_rgba(34,34,34,0.15)]">
                            <div class="dz-media relative overflow-hidden">
                                <img src="assets/images/gallery/grid4/pic1.jpg" alt="/" class="duration-300">
                                <div class="dz-meta">
                                    <ul>
                                        <li class="absolute top-0 bg-[#FE9F10] left-0 text-white rounded-ee-[10px] uppercase py-[4px] px-2.5 font-semibold text-xs leading-[18px] z-[2]">Top Seller</li>
                                        <li class="rating absolute bottom-[20px] right-[20px] bg-white text-[#222222] rounded-md text-sm font-medium py-1 px-[10px] mr-0"><i class="fa-solid fa-star text-[#FE9F10] text-xs top-[-2px] mr-[5px] relative scale-[1.2]"></i> 4.5</li>
                                    </ul>
                                </div>
                            </div>
					...
					<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] mb-[30px] All pizza sweet">
						<div class="dz-img-box7 rounded-[10px] bg-white text-center relative h-full duration-200 overflow-hidden z-[1] shadow-[0px_15px_55px_rgba(34,34,34,0.15)]">
                            <div class="dz-media relative overflow-hidden">
                                <img src="assets/images/gallery/grid4/pic2.jpg" alt="/" class="duration-300">
                                <div class="dz-meta">
                                    <ul>
                                        <li class="absolute top-0 bg-[#FE9F10] left-0 text-white rounded-ee-[10px] uppercase py-[4px] px-2.5 font-semibold text-xs leading-[18px] z-[2]">Top Seller</li>
                                        <li class="rating absolute bottom-[20px] right-[20px] bg-white text-[#222222] rounded-md text-sm font-medium py-1 px-[10px] mr-0"><i class="fa-solid fa-star text-[#FE9F10] text-xs top-[-2px] mr-[5px] relative scale-[1.2]"></i> 4.5</li>
                            ...
                            <div class="dz-content flex flex-col lg:py-[25px] py-5 lg:px-5 px-[15px]">
                                <h5 class="title text-black2 mb-2"><a href="product-detail.html">Chicken Burger</a></h5>
                                <p class="mb-[10px] text-sm">It is a long established fact that a reader will be distracted by the readable.</p>
                                <span class="price text-2xl font-semibold leading-[1.1]">$17.56</span>
                            </div>
                        </div>
					</li>
					<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] mb-[30px] All salad spicy">
						<div class="dz-img-box7 rounded-[10px] bg-white text-center relative h-full duration-200 overflow-hidden z-[1] shadow-[0px_15px_55px_rgba(34,34,34,0.15)]">
                            <div class="dz-media relative overflow-hidden">
                                <img src="assets/images/gallery/grid4/pic3.jpg" alt="/" class="duration-300">
                                <div class="dz-meta">
                                    <ul>
                                        <li class="absolute top-0 bg-[#FE9F10] left-0 text-white rounded-ee-[10px] uppercase py-[4px] px-2.5 font-semibold text-xs leading-[18px] z-[2]">Top Seller</li>
                                        <li class="rating absolute bottom-[20px] right-[20px] bg-white text-[#222222] rounded-md text-sm font-medium py-1 px-[10px] mr-0"><i class="fa-solid fa-star text-[#FE9F10] text-xs top-[-2px] mr-[5px] relative scale-[1.2]"></i> 4.5</li>
                            ...
                            <div class="dz-content flex flex-col lg:py-[25px] py-5 lg:px-5 px-[15px]">
                                <h5 class="title text-black2 mb-2"><a href="product-detail.html">Pineapple Pizza</a></h5>
                                <p class="mb-[10px] text-sm">It is a long established fact that a reader will be distracted by the readable.</p>
                                <span class="price text-2xl font-semibold leading-[1.1]">$24.50</span>
                            </div>
                        </div>
					</li>
					<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] mb-[30px] All drink spicy sweet">
						<div class="dz-img-box7 rounded-[10px] bg-white text-center relative h-full duration-200 overflow-hidden z-[1] shadow-[0px_15px_55px_rgba(34,34,34,0.15)]">
                            <div class="dz-media relative overflow-hidden">
                                <img src="assets/images/gallery/grid4/pic4.jpg" alt="/" class="duration-300">
                                <div class="dz-meta">
                                    <ul>
                                        <li class="absolute top-0 bg-[#FE9F10] left-0 text-white rounded-ee-[10px] uppercase py-[4px] px-2.5 font-semibold text-xs leading-[18px] z-[2]">Top Seller</li>
                                        <li class="rating absolute bottom-[20px] right-[20px] bg-white text-[#222222] rounded-md text-sm font-medium py-1 px-[10px] mr-0"><i class="fa-solid fa-star text-[#FE9F10] text-xs top-[-2px] mr-[5px] relative scale-[1.2]"></i> 4.5</li>
                            ...
                            <div class="dz-content flex flex-col lg:py-[25px] py-5 lg:px-5 px-[15px]">
                                <h5 class="title text-black2 mb-2"><a href="product-detail.html">Pineapple Soup</a></h5>
                                <p class="mb-[10px] text-sm">It is a long established fact that a reader will be distracted by the readable.</p>
                                <span class="price text-2xl font-semibold leading-[1.1]">$11.02</span>
                            </div>
                        </div>
					</li>
					<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] mb-[30px] All burger">
						<div class="dz-img-box7 rounded-[10px] bg-white text-center relative h-full duration-200 overflow-hidden z-[1] shadow-[0px_15px_55px_rgba(34,34,34,0.15)]">
                            <div class="dz-media relative overflow-hidden">
                                <img src="assets/images/gallery/grid4/pic5.jpg" alt="/" class="duration-300">
                                <div class="dz-meta">
                                    <ul>
                                        <li class="absolute top-0 bg-[#FE9F10] left-0 text-white rounded-ee-[10px] uppercase py-[4px] px-2.5 font-semibold text-xs leading-[18px] z-[2]">Top Seller</li>
                                        <li class="rating absolute bottom-[20px] right-[20px] bg-white text-[#222222] rounded-md text-sm font-medium py-1 px-[10px] mr-0"><i class="fa-solid fa-star text-[#FE9F10] text-xs top-[-2px] mr-[5px] relative scale-[1.2]"></i> 4.5</li>
                            ...
                            <div class="dz-content flex flex-col lg:py-[25px] py-5 lg:px-5 px-[15px]">
                                <h5 class="title text-black2 mb-2"><a href="product-detail.html">Momos</a></h5>
                                <p class="mb-[10px] text-sm">It is a long established fact that a reader will be distracted by the readable.</p>
                                <span class="price text-2xl font-semibold leading-[1.1]">$4.56</span>
                            </div>
                        </div>
					</li>
					<li class="card-container lg:w-1/3 md:w-1/2	w-full px-[15px] mb-[30px] All pizza burger">
						<div class="dz-img-box7 rounded-[10px] bg-white text-center relative h-full duration-200 overflow-hidden z-[1] shadow-[0px_15px_55px_rgba(34,34,34,0.15)]">
                            <div class="dz-media relative overflow-hidden">
                                <img src="assets/images/gallery/grid4/pic6.jpg" alt="/" class="duration-300">
                                <div class="dz-meta">
                                    <ul>
                                        <li class="absolute top-0 bg-[#FE9F10] left-0 text-white rounded-ee-[10px] uppercase py-[4px] px-2.5 font-semibold text-xs leading-[18px] z-[2]">Top Seller</li>
                                        <li class="rating absolute bottom-[20px] right-[20px] bg-white text-[#222222] rounded-md text-sm font-medium py-1 px-[10px] mr-0"><i class="fa-solid fa-star text-[#FE9F10] text-xs top-[-2px] mr-[5px] relative scale-[1.2]"></i> 4.5</li>
                            ...
                            <div class="dz-content flex flex-col lg:py-[25px] py-5 lg:px-5 px-[15px]">
                                <h5 class="title text-black2 mb-2"><a href="product-detail.html">Pancake</a></h5>
                                <p class="mb-[10px] text-sm">It is a long established fact that a reader will be distracted by the readable.</p>
                                <span class="price text-2xl font-semibold leading-[1.1]">$12.20</span>
                            </div>
                        </div>
					</li>
				</ul>
				...
				<div class="row">
					...
					<div class="xl:w-3/12 lg:w-2/12 sm:w-6/12 w-full px-[15px]">
							<div class="widget widget_services mb-[30px]">
								<h5 class="footer-title mb-[30px] xl:text-2xl text-xl font-semibold text-white uppercase leading-[1.1]">Our Links</h5>
								<ul>
					...
					<div class="xl:w-3/12 lg:w-3/12 sm:w-6/12 w-full px-[15px]	">
							<div class="widget widget_services mb-[30px]">
								<h5 class="footer-title mb-[30px] xl:text-2xl text-xl font-semibold text-white uppercase leading-[1.1]">Help Center</h5>
								<ul>
			...
			<div class="footer-bottom relative py-5 border-t border-[#ffffff1a]">
				<div class="row">
					...
					<div class="md:w-1/2 w-full md:text-right text-center px-[15px] md:mt-0 mt-[15px]">
						<span class="text-sm text-[#999999]">Crafted With <span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span> by <a href="https://dexignzone.com/" target="_blank" class="text-primary">DexignZone</a></span>
					</div>
				</div>
            </div>
		</div>
	...
	<div class="offcanvas offcanvas-end filter-category-sidebar fixed top-0 translate-x-full z-[999] h-screen overflow-y-auto bg-white dark:bg-gray-800 xl:w-[510px] sm:w-[400px] w-[325px] pt-[50px] px-[30px] pb-5 max-md:p-5 max-md:pt-[50px] duration-500" id="offcanvasFilter" >
		<button type="button" class="btn-close style-1 text-2xl leading-7 absolute left-[10px] top-[10px] p-0"><i class="la la-close"></i></button>
		<div class="offcanvas-body">
			<div class="widget mb-[30px]">
				<div class="widget-title xl:mb-[30px] mb-5 pb-3 relative">
					<h4 class="text-xl">Refine By Categories</h4>
				</div>
				<div class="category-check-list flex flex-wrap mb-[10px] w-full">
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-01">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-01">
							Pizza
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-02">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-02">
							Hamburger
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-03">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-03">
							Cold Drink
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-04">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-04">
							Sandwich
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-05">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-05">
							Muffin
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-06">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-06">
							Burrito
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-07">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-07">
							Taco
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-08">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-08">
							Hot Dog
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-09">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-09">
							Noodles
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-10">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-10">
							Macrony
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-11">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-11">
							Cheese Pasta
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-12">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-12">
							Fish Fry
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-13">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-13">
							Cold Coffee
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-14">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-14">
							Manchurian
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-15">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-15">
							Dosa
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-16">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-16">
							Momos
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-17">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-17">
							Soup
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-18">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-18">
							Chicken Burger
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-19">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-19">
							Beverages
						</label>
					</div>
					<div class="form-check mb-[10px] block w-[50%] min-h-[1.5rem]">
						<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-20">
						<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-20">
							Lemon Lime Soda
						</label>
					</div>
				</div>
			...
			<div class="widget mb-[30px]">
				<div class="widget-title xl:mb-[30px] mb-5 pb-3 relative">
					<h4 class="text-xl">Near Me</h4>
				</div>
				<div class="form-check mb-[10px] block min-h-[1.5rem]">
					<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-21">
					<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-21">
						Ortus Restaurant
					</label>
				</div>
				<div class="form-check mb-[10px] block min-h-[1.5rem]">
					<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-22">
					<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-22">
						Amar Punjabi Restaurant
					</label>
				</div>
				<div class="form-check mb-[10px] block min-h-[1.5rem]">
					<input class="form-check-input w-[15px] h-[15px] rounded border border-[#2222224d] float-left appearance-none p-[6px]" type="checkbox" value="" id="productCheckBox-23">
					<label class="form-check-label ml-[15px] sm:text-[15px] text-[13px] inline-block text-bodycolor" for="productCheckBox-23">
						Other
					</label>
				</div>
			</div>
			<div class="widget rating-filter mb-[30px]">
				<div class="widget-title xl:mb-[30px] mb-5 pb-3 relative">
					<h4 class="text-xl">Rating</h4>
				</div>
				<ul>
					<li class="inline-block mr-2"><span class="font-medium">5 Star</span></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
				...
				<ul>
					<li class="inline-block mr-2"><span class="font-medium">4 Star</span></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
				...
				<ul>
					<li class="inline-block mr-2"><span class="font-medium">3 Star</span></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
				</ul>
				<ul>
					<li class="inline-block mr-2"><span class="font-medium">2 Star</span></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
				</ul>
				<ul>
					<li class="inline-block mr-2"><span class="font-medium">1 Star</span></li>
					<li class="inline-block"><i class="icon-star-on text-[var(--secondary-dark)]"></i></li>
				</ul>
			</div>
			<div class="widget mb-[30px]">
...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/our-menu-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:38 GMT -->
</html>