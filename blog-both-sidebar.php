...
<!-- Mirrored from swigo.dexignzone.com/tailwind/xhtml/blog-both-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Oct 2024 04:30:49 GMT -->
<head>	

    <!-- Title -->
    <title>Restaurant Website Templates | Swigo - Empowering Your Food Business | DexignZone | Tailwind</title>
	...
	<meta property="og:title" content="Swigo - Empowering Your Restaurant Website Templates | DexignZone | Tailwind">
...
<body class="box-border p-0 m-0 selection:bg-primary selection:text-white font-poppins">
...
<div class="progress-wrap">
	...
	<!--drawer-->
	<div id="drawer1" class="fixed top-0 z-[99] h-screen overflow-y-auto translate-x-full bg-white dark:bg-gray-800">
	...
	<div id="drawer2" class="fixed top-0 z-[99] h-screen overflow-y-auto translate-x-full bg-white dark:bg-gray-800">
		<div class="p-0 overflow-y-auto">
			...
			<div class="py-[60px] px-[70px]">
				...
				<form>
					...
					<div class="mb-[30px]">
						...
						<div class="input-group relative">
							<input name="dzPassword" required="" type="text" class="dzPassword mt-2.5 flex relative border border-[#dddddd] w-full rounded-md py-2.5 px-5 focus:ring-primary" placeholder="Create a Password">
							<div class="show-pass">
								<svg class="eye-close" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#8ea5c8"><path d="M11 17.188a8.71 8.71 0 0 1-1.576-.147.69.69 0 0 1-.579-.678.7.7 0 0 1 .817-.676 7.33 7.33 0 0 0 1.339.127c4.073 0 7.61-3.566 8.722-4.812a18.51 18.51 0 0 0-2.434-2.274.69.69 0 0 1 .335-1.226.69.69 0 0 1 .268.019c.087.024.169.064.24.12a18.79 18.79 0 0 1 3.036 2.939.69.69 0 0 1 0 .848c-.185.234-4.581 5.763-10.167 5.763zm7.361-13.549a.69.69 0 0 0-.972 0l-2.186 2.186a10.68 10.68 0 0 0-2.606-.864c-.527-.099-1.061-.149-1.597-.149-5.585 0-9.982 5.528-10.166 5.763a.69.69 0 0 0 0 .848c.897 1.09 1.915 2.075 3.033 2.936.529.415 1.083.796 1.66 1.142l-1.888 1.887c-.066.063-.118.139-.154.223a.69.69 0 0 0 .145.757.67.67 0 0 0 .226.15c.085.034.175.052.266.051a.69.69 0 0 0 .265-.056c.084-.036.16-.088.223-.154l13.75-13.75a.69.69 0 0 0 0-.972zm-13.65 9.636A18.51 18.51 0 0 1 2.278 11C3.39 9.754 6.927 6.187 11 6.187a7.31 7.31 0 0 1 1.348.127 8.92 8.92 0 0 1 1.814.55L12.895 8.13c-.661-.437-1.453-.632-2.241-.552a3.44 3.44 0 0 0-2.085.989c-.56.56-.91 1.297-.989 2.085a3.44 3.44 0 0 0 .552 2.241l-1.601 1.604a14.43 14.43 0 0 1-1.82-1.222zm4.432-1.392c-.134-.275-.204-.577-.206-.883a2.07 2.07 0 0 1 .6-1.456 2.12 2.12 0 0 1 2.338-.392l-2.731 2.731z"></path>
								</svg>
									<svg class="eye-open" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#8ea5c8"><path d="M19.873 9.611c-.179-.244-4.436-5.985-9.873-5.985S.305 9.367.127 9.611a.66.66 0 0 0 0 .778c.178.244 4.436 5.985 9.873 5.985s9.694-5.74 9.873-5.984a.66.66 0 0 0 0-.778zM10 15.055c-4.005 0-7.474-3.81-8.501-5.055C2.525 8.753 5.986 4.945 10 4.945c4.005 0 7.473 3.809 8.501 5.055-1.025 1.247-4.487 5.054-8.501 5.054zm0-9.011A3.96 3.96 0 0 0 6.044 10 3.96 3.96 0 0 0 10 13.956 3.96 3.96 0 0 0 13.956 10 3.96 3.96 0 0 0 10 6.044zm0 6.593A2.64 2.64 0 0 1 7.363 10 2.64 2.64 0 0 1 10 7.363 2.64 2.64 0 0 1 12.637 10 2.64 2.64 0 0 1 10 12.637z"></path>
    ...
    <!-- Banner  -->
    <section class="bg-[url('../images/banner/bnr1.jpg')] bg-fixed relative z-[1] after:content-[''] after:absolute after:z-[-1] after:bg-[#222222e6] after:opacity-100 after:w-full after:h-full after:top-0 after:left-0  pt-[50px] lg:h-[450px] sm:h-[400px] h-[300px] overflow-hidden bg-cover bg-center">
        <div class="container table h-full relative z-[1] text-center">
            <div class="dz-bnr-inr-entry align-middle table-cell">
                <h2 class="font-lobster text-white mb-5 2xl:text-[70px] md:text-[60px] text-[40px] leading-[1.2]">Blog Both Sidebar</h2>
                <!-- Breadcrumb Row -->
                <nav aria-label="breadcrumb" class="breadcrumb-row">
                    <ul class="breadcrumb bg-primary shadow-[0px_10px_20px_rgba(0,0,0,0.05)] rounded-[10px] inline-block lg:py-[13px] md:py-[10px] sm:py-[5px] py-[7px] lg:px-[30px] md:px-[18px] sm:px-5 px-3.5 m-0">
                        ...
                        <li class="breadcrumb-item text-white p-0 inline-block text-[15px] font-normal pl-2 active">Blog Both Sidebar</li>
                    </ul>
                </nav>
                <!-- Breadcrumb Row End -->
            </div>
    ...
    <!-- Blog Section -->
		<section class="lg:pt-[100px] sm:pt-[70px] pt-[50px] lg:pb-[100px] sm:pb-10 pb-5 relative bg-white">
			<div class="container">
				<div class="row">
					<div class="xl:w-1/4 lg:w-5/12 md:w-1/2 w-full px-[15px] mb-[30px] lg:order-1 order-2">
						<aside class="lg:sticky pr-5 max-xl:pr-0 pb-[1px] top-[100px]">
							<div class="md:mb-[50px] sm:mb-[30px] mb-4">
								<div class="widget-title xl:mb-[25px] mb-5 pb-3 text-lg relative">
									<h5 class="">Latest Post</h5>
								</div>
								<div class="widget-post-bx">
									<div class="widget-post clearfix flex items-center p-[10px] rounded-[10px] border border-[#2222221a] mb-[15px]">
										<div class="dz-media h-[80px] w-[100px] min-w-[100px] max-xl:w-[80px] max-xl:min-w-[80px] mr-[15px] rounded-md overflow-hidden"> 
											<img src="assets/images/blog/recent-blog/pic1.jpg" alt="/">
										</div>
										<div class="dz-info relative">
											<h6 class="text-base mb-2"><a href="blog-standard.html">Explore the Food Taste</a></h6>
											<div class="mb-0">
                                                <ul class="flex items-center max-2xl:block max-xl:mx-[-6px]">
                                                    <li class="inline-block relative text-[13px] mr-3">
                                                        <a href="javascript:void(0);" class="text-[13px] font-medium text-bodycolor"><i class="flaticon-calendar-date text-xs text-primary mr-[5px] translate-y-[1px] scale-150"></i> 30 Nov 2024</a>
                                                    </li>
                                                </ul>
                                            </div>
										</div>
									...
									<div class="widget-post clearfix flex items-center p-[10px] rounded-[10px] border border-[#2222221a] mb-[15px]">
										...
										<div class="dz-info relative">
											<h6 class="text-base mb-2"><a href="blog-standard.html">Delicious Food Secret</a></h6>
											<div class="mb-0">
                                                <ul class="flex items-center max-2xl:block max-xl:mx-[-6px]">
                                                    <li class="inline-block relative text-[13px] mr-3">
                                                        <a href="javascript:void(0);" class="text-[13px] font-medium text-bodycolor"><i class="flaticon-calendar-date text-xs text-primary mr-[5px] translate-y-[1px] scale-150"></i> 30 Nov 2024</a>
									...
									<div class="widget-post clearfix flex items-center p-[10px] rounded-[10px] border border-[#2222221a] mb-[15px]">
										...
										<div class="dz-info relative">
											<h6 class="text-base mb-2"><a href="blog-standard.html">Inspiration for Food</a></h6>
											<div class="mb-0">
                                                <ul class="flex items-center max-2xl:block max-xl:mx-[-6px]">
                                                    <li class="inline-block relative text-[13px] mr-3">
                                                        <a href="javascript:void(0);" class="text-[13px] font-medium text-bodycolor"><i class="flaticon-calendar-date text-xs text-primary mr-[5px] translate-y-[1px] scale-150"></i> 30 Nov 2024</a>
                            ...
                            <div class="md:mb-[sm:50px] mb- mb-4[30px] widget_categories">
								<div class="widget-title xl:mb-[25px] mb-5 pb-3 text-lg relative">
									<h5 class="">Categories</h5>
								</div>
								<ul>
									<li class="cat-item text-right table w-full py-[10px] pl-5 leading-[1.3] relative"><a href="blog-standard.html" class="text-bodycolor text-[15px] font-medium float-left text-left">Pepperoni Pizza</a></li>
									<li class="cat-item text-right table w-full py-[10px] pl-5 leading-[1.3] relative"><a href="blog-standard.html" class="text-bodycolor text-[15px] font-medium float-left text-left">Apricot Chicken</a></li>                       
									<li class="cat-item text-right table w-full py-[10px] pl-5 leading-[1.3] relative"><a href="blog-standard.html" class="text-bodycolor text-[15px] font-medium float-left text-left">Pizza Veronese</a></li>
									<li class="cat-item text-right table w-full py-[10px] pl-5 leading-[1.3] relative"><a href="blog-standard.html" class="text-bodycolor text-[15px] font-medium float-left text-left">Summer Pizza</a></li>
									<li class="cat-item text-right table w-full py-[10px] pl-5 leading-[1.3] relative"><a href="blog-standard.html" class="text-bodycolor text-[15px] font-medium float-left text-left">Italian Tuna</a></li> 
								</ul>
							</div>
						</aside>
					</div>
					<div class="xl:w-1/2 lg:w-7/12 col-md-12 w-full px-[15px] mb-[30px] lg:order-1 order-1">
						<div class="row justify-center loadmore-content">
                            <div class="w-full px-[15px]">
                                <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] sm:flex bg-white group mb-[30px]">
                                    <div class="dz-media sm:min-w-[240px] sm:w-[240px] w-full sm:h-auto h-[250px] mb-0 relative overflow-hidden">
                                        <a href="javascript:void(0);" class="block h-full">
                                            <img src="assets/images/blog/grid/pic1.jpg" alt="/" class="h-full object-cover w-full group-hover:scale-110 duration-500">
                                        </a>
                                    </div>
                                    <div class="content flex-col flex py-[25px] px-[30px] relative">
                                        <div class="mb-2.5">
											<ul class="flex items-center">
												<li class="inline-block relative text-[13px] mr-3">
													<a href="javascript:void(0);" class="text-sm font-medium text-bodycolor"><i class="flaticon-calendar-date text-xs text-primary mr-[5px] translate-y-[1px] scale-150"></i> 30 Nov 2024</a>
												</li>
												<li class="dz-comment"><a href="javascript:void(0);" class="text-sm font-medium text-bodycolor"><i class="flaticon-chat-bubble text-base text-primary mr-[5px]"></i> 3.5K </a></li>
											</ul>
                                        </div>
                                        <h5 class="mb-2">Paradise Taste of Dishes</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have.</p>
                                        <div>
                                            <a href="blog-standard.html" class="py-3 px-6 text-sm font-medium relative inline-flex items-center justify-center rounded-md mt-[18px]  bg-primary border-primary text-white btn-hover-2">Read More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full px-[15px]">
                                <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] sm:flex bg-white group mb-[30px]">
                                    <div class="dz-media sm:min-w-[240px] sm:w-[240px] w-full sm:h-auto h-[250px] mb-0 relative overflow-hidden">
                                        <a href="javascript:void(0);" class="block h-full">
                                            <img src="assets/images/blog/grid/pic2.jpg" alt="/" class="h-full object-cover w-full group-hover:scale-110 duration-500">
                                        </a>
                                    </div>
                                    <div class="content flex-col flex py-[25px] px-[30px] relative">
                                        <div class="mb-0">
                                        ...
                                        <h5 class="mb-2">Taste of Paradise Dishes</h5>
					                         <p>There are many variations of passages of Lorem Ipsum available, but the majority have.</p>
                                        <div>
                                            <a href="blog-standard.html" class="py-3 px-6 text-sm font-medium relative inline-flex items-center justify-center rounded-md mt-[18px] bg-primary border-primary text-white btn-hover-2">Read More</a>
                                        </div>
                            ...
                            <div class="w-full px-[15px]">
                                <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] sm:flex bg-white group mb-[30px]">
                                    <div class="dz-media sm:min-w-[240px] sm:w-[240px] w-full sm:h-auto h-[250px] mb-0 relative overflow-hidden">
                                        <a href="javascript:void(0);" class="block h-full">
                                            <img src="assets/images/blog/grid/pic3.jpg" alt="/" class="h-full object-cover w-full group-hover:scale-110 duration-500">
                                        </a>
                                    </div>
                                    <div class="content flex-col flex py-[25px] px-[30px] relative">
                                        <div class="mb-0">
                                        ...
                                        <h5 class="mb-2">The Fork & Knife</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have.</p>
                                        <div>
                                            <a href="blog-standard.html" class="py-3 px-6 text-sm font-medium relative inline-flex items-center justify-center rounded-md mt-[18px]  bg-primary border-primary text-white btn-hover-2">Read More</a>
                                        </div>
                            ...
                            <div class="w-full px-[15px]">
                                <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] sm:flex bg-white group mb-[30px]">
                                    <div class="dz-media sm:min-w-[240px] sm:w-[240px] w-full sm:h-auto h-[250px] mb-0 relative overflow-hidden">
                                        <a href="javascript:void(0);" class="block h-full">
                                            <img src="assets/images/blog/grid/pic4.jpg" alt="/" class="h-full object-cover w-full group-hover:scale-110 duration-500">
                                        </a>
                                    </div>
                                    <div class="content flex-col flex py-[25px] px-[30px] relative">
                                        <div class="mb-0">
                                        ...
                                        <h5 class="mb-2">Flavors Of The World</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have.</p>
                                        <div>
                                            <a href="blog-standard.html" class="py-3 px-6 text-sm font-medium relative inline-flex items-center justify-center rounded-md mt-[18px]  bg-primary border-primary text-white btn-hover-2">Read More</a>
                                        </div>
                            ...
                            <div class="w-full px-[15px]">
                                <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] sm:flex bg-white group mb-[30px]">
                                    <div class="dz-media sm:min-w-[240px] sm:w-[240px] w-full sm:h-auto h-[250px] mb-0 relative overflow-hidden">
                                        <a href="javascript:void(0);" class="block h-full">
                                            <img src="assets/images/blog/grid/pic5.jpg" alt="/" class="h-full object-cover w-full group-hover:scale-110 duration-500">
                                        </a>
                                    </div>
                                    <div class="content flex-col flex py-[25px] px-[30px] relative">
                                        <div class="mb-0">
                                        ...
                                        <h5 class="mb-2">Tabletop Treats Cheese</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have.</p>
                                        <div>
                                            <a href="blog-standard.html" class="py-3 px-6 text-sm font-medium relative inline-flex items-center justify-center rounded-md mt-[18px]  bg-primary border-primary text-white btn-hover-2">Read More</a>
                                        </div>
                            ...
                            <div class="w-full px-[15px]">
                                <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] sm:flex bg-white group mb-[30px]">
                                    <div class="dz-media sm:min-w-[240px] sm:w-[240px] w-full sm:h-auto h-[250px] mb-0 relative overflow-hidden">
                                        <a href="javascript:void(0);" class="block h-full">
                                            <img src="assets/images/blog/grid/pic6.jpg" alt="/" class="h-full object-cover w-full group-hover:scale-110 duration-500">
                                        </a>
                                    </div>
                                    <div class="content flex-col flex py-[25px] px-[30px] relative">
                                        <div class="mb-0">
                                        ...
                                        <h5 class="mb-2">Palate Pleaser Dishes</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have.</p>
                                        <div>
                                            <a href="blog-standard.html" class="py-3 px-6 text-sm font-medium relative inline-flex items-center justify-center rounded-md mt-[18px]  bg-primary border-primary text-white btn-hover-2">Read More</a>
                                        </div>
                            ...
                            <div class="w-full px-[15px]">
                                <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] sm:flex bg-white group mb-[30px]">
                                    <div class="dz-media sm:min-w-[240px] sm:w-[240px] w-full sm:h-auto h-[250px] mb-0 relative overflow-hidden">
                                        <a href="javascript:void(0);" class="block h-full">
                                            <img src="assets/images/blog/grid/pic7.jpg" alt="/" class="h-full object-cover w-full group-hover:scale-110 duration-500">
                                        </a>
                                    </div>
                                    <div class="content flex-col flex py-[25px] px-[30px] relative">
                                        <div class="mb-0">
                                        ...
                                        <h5 class="mb-2">Savory Sensations</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have.</p>
                                        <div>
                                            <a href="blog-standard.html" class="py-3 px-6 text-sm font-medium relative inline-flex items-center justify-center rounded-md mt-[18px]  bg-primary border-primary text-white btn-hover-2">Read More</a>
                                        </div>
                            ...
                            <div class="w-full px-[15px]">
                                <div class="overlay-shine rounded-lg overflow-hidden shadow-[0_15px_55px_rgba(34,34,34,0.1)] sm:flex bg-white group mb-[30px]">
                                    <div class="dz-media sm:min-w-[240px] sm:w-[240px] w-full sm:h-auto h-[250px] mb-0 relative overflow-hidden">
                                        <a href="javascript:void(0);" class="block h-full">
                                            <img src="assets/images/blog/grid/pic8.jpg" alt="/" class="h-full object-cover w-full group-hover:scale-110 duration-500">
                                        </a>
                                    </div>
                                    <div class="content flex-col flex py-[25px] px-[30px] relative">
                                        <div class="mb-0">
                                        ...
                                        <h5 class="mb-2">The Hungry Hunter</h5>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have.</p>
                                        <div>
                                            <a href="blog-standard.html" class="py-3 px-6 text-sm font-medium relative inline-flex items-center justify-center rounded-md mt-[18px]  bg-primary border-primary text-white btn-hover-2">Read More</a>
                                        </div>
						...
						<div class="text-center m-t10">
							<div class="text-center mx-auto mt-[10px]">
                                <ul class="pagination flex justify-center mb-[15px]">
                                    <li class="page-item mx-2"><a class="page-link w-[45px] min-w-[45px] leading-[45px] text-center rounded-lg bg-white text-primary shadow-[0px_5px_25px_rgba(0,0,0,0.1)] block relative duration-500 hover:bg-primary hover:text-white  prev" href="javascript:void(0);"><i class="fas fa-chevron-left"></i></a></li>
                                    <li class="page-item mx-2"><a class="page-link w-[45px] min-w-[45px] leading-[45px] text-center rounded-lg bg-primary text-white shadow-[0px_5px_25px_rgba(0,0,0,0.1)] block relative duration-500  active" href="javascript:void(0);"><span>1</span></a></li>
                                    <li class="page-item mx-2"><a class="page-link w-[45px] min-w-[45px] leading-[45px] text-center rounded-lg bg-white text-primary shadow-[0px_5px_25px_rgba(0,0,0,0.1)] block relative duration-500 hover:bg-primary hover:text-white " href="javascript:void(0);"><span>2</span></a></li>
                                    <li class="page-item mx-2"><a class="page-link w-[45px] min-w-[45px] leading-[45px] text-center rounded-lg bg-white text-primary shadow-[0px_5px_25px_rgba(0,0,0,0.1)] block relative duration-500 hover:bg-primary hover:text-white " href="javascript:void(0);"><span>3</span></a></li>
                                    <li class="page-item mx-2"><a class="page-link w-[45px] min-w-[45px] leading-[45px] text-center rounded-lg bg-white text-primary shadow-[0px_5px_25px_rgba(0,0,0,0.1)] block relative duration-500 hover:bg-primary hover:text-white  next" href="javascript:void(0);"><i class="fas fa-chevron-right"></i></a></li>
                                </ul>
                            </div>
						</div>
					</div>
					<div class="xl:w-1/4 lg:w-5/12 md:w-1/2 w-full px-[15px] mb-[30px] lg:order-3 order-1 xl:block hidden">
						<aside class="lg:sticky pl-5 max-xl:pl-0 pb-[1px] top-[100px]">
							<div class="md:mb-[50px] sm:mb-[30px] mb-4">
								<div class="widget-title xl:mb-[25px] mb-5 pb-3 text-lg relative">
									<h5 class="">Search</h5>
								</div>
								<form role="search" method="post" class="mb-[10px]">
									<div class="input-group flex flex-wrap relative items-stretch w-full">
										<div class="input-side bg-primary rounded-md flex m-0 p-[5px] items-center w-full h-[60px]">
											<input name="text" class="bg-white border-0 rounded-md z-0 h-[50px] py-[6px] pl-5 w-full outline-none" placeholder="Search" type="text">
											<div class="input-group-btn">
												<button type="submit" class="btn ml-[5px] w-[50px] min-w-[50px] h-[50px] p-0 justify-center">
							...
							<div class="mb-[50px] widget_categories">
								<div class="widget-title xl:mb-[25px] mb-5 pb-3 text-lg relative">
									<h5 class="">Categories</h5>
								</div>
								<ul>
                            ...
                            <div class="widget md:mb-[50px] sm:mb-[30px] mb-4 widget_tag_cloud">
								<div class="flex justify-between">
									<div class="widget-title xl:mb-[25px] mb-5 pb-3 relative">
										<h5 class="text-xl">Popular Tags</h5>
									</div>
								</div>
								<div class="tagcloud table"> 
									<a href="product-detail.html" class="relative py-[9px] px-[15px] inline-block mr-[10px] mb-[10px] text-sm font-normal leading-[1.4] bg-white rounded-lg text-[#666666] border border-[#2222221a]">Pizza</a>
									<a href="product-detail.html" class="relative py-[9px] px-[15px] inline-block mr-[10px] mb-[10px] text-sm font-normal leading-[1.4] bg-white rounded-lg text-[#666666] border border-[#2222221a]">Chicken</a>
									<a href="product-detail.html" class="relative py-[9px] px-[15px] inline-block mr-[10px] mb-[10px] text-sm font-normal leading-[1.4] bg-white rounded-lg text-[#666666] border border-[#2222221a]">Pizza Veronese</a>
                                    <a href="product-detail.html" class="relative py-[9px] px-[15px] inline-block mr-[10px] mb-[10px] text-sm font-normal leading-[1.4] bg-white rounded-lg text-[#666666] border border-[#2222221a]">Burger</a>
									<a href="product-detail.html" class="relative py-[9px] px-[15px] inline-block mr-[10px] mb-[10px] text-sm font-normal leading-[1.4] bg-white rounded-lg text-[#666666] border border-[#2222221a]">Sandwich</a>
								</div>
							</div>
						</aside>
					</div>
	...
	<!-- Footer -->
	<section class="bg-black2 relative site-footer style-1">
				...
				<div class="row">
					<div class="xl:w-1/4 lg:w-1/3 sm:w-1/2 w-full px-[15px]">
						<div class=" sm:mb-[30px] mb-2.5">
							<h5 class="footer-title lg:mb-[30px] mb-5 text-white lg:text-2xl text-xl uppercase font-semibold">Contact</h5>
							<ul>
								<li class="relative mb-[25px] pl-10">
									<i class="flaticon-placeholder absolute text-3xl leading-[30px] left-0 top-[5px] text-primary w-[30px] h-[30px]"></i>
									<p class="text-[#CCCCCC] tracking-wide leading-6">1247/Plot No. 39, 15th Phase, Colony, Kkatpally, Hyderabad</p>
								</li>
								<li class="relative mb-[25px] pl-10">
									<i class="flaticon-telephone absolute text-3xl leading-[30px] left-0 top-[5px] text-primary w-[30px] h-[30px]"></i>
									<p class="text-[#CCCCCC] tracking-wide leading-6">+91 987-654-3210<br>
										+91 123-456-7890</p>
								</li>
								<li class="relative mb-[25px] pl-10">
									<i class="flaticon-email-1 absolute text-3xl leading-[30px] left-0 top-[5px] text-primary w-[30px] h-[30px]"></i>
					...
					<div class="xl:w-1/4 lg:w-1/6 sm:w-1/2 w-full px-[15px]">
						<div class=" sm:mb-[30px] mb-2.5">
							<h5 class="footer-title lg:mb-[30px] mb-5 text-white lg:text-2xl text-xl uppercase font-semibold">our links</h5>
							<ul>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300  before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">Home</span></a></li>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300  before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">About Us</span></a></li>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300  before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">Services</span></a></li>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300  before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">Team</span></a></li>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300 before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">Blog</span></a></li>
							</ul>
						</div>
					</div>
                    <div class="lg:w-1/4 sm:w-1/2 w-full px-[15px]">
                        <div class="widget widget_services mb-[30px]">
                            <h5 class="footer-title mb-[30px] xl:text-2xl text-xl font-semibold text-white uppercase leading-[1.1]">OUR SERVICES</h5>
                            <ul>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300  before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">Strategy & Research</span></a></li>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300  before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">Fast Delivery</span></a></li>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300  before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">Seat Reservation</span></a></li>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300  before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">Pickup In Store</span></a></li>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300 before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">Our Menu</span></a></li>
							</ul>
                        </div>
                    </div>
					<div class="lg:w-1/4 sm:w-1/2 w-full px-[15px]">
						<div class="sm:mb-[30px] mb-2.5">
							<h5 class="footer-title lg:mb-[30px] mb-5 text-white lg:text-2xl text-xl uppercase font-semibold">help center</h5>
							<ul>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300 before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">FAQ</span></a></li>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300 before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">Shop</span></a></li>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300 before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">Category Filter</span></a></li>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300 before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">Testimonials</span></a></li>
								<li class="pb-[15px] group"><a href="javascript:void(0);"><span class="text-[#CCCCCC] relative before:content-[''] before:w-0 before:bg-primary before:duration-300 before:absolute before:h-[1px] before:left-0 before:bottom-0 group-hover:before:w-full group-hover:text-primary duration-300 text-[15px]">Contact Us</span></a></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="footer-bottom relative py-5 border-t border-[#ffffff1a]">
				<div class="row">
					<div class="md:w-1/2 md:text-left mx-auto px-[15px]">
						<p class="text-sm text-[#999999]">Copyright 2024 All rights reserved.</p>
					</div>
					<div class="lg:w-1/2 lg:text-right mx-auto px-[15px]">
						<span class="text-sm text-[#999999]">Crafted With <span class="bg-heart w-[60px] h-[60px] inline-block my-[-25px] mx-[-18px]"></span> by <a href="javascript:void(0);" target="_blank" class="text-primary">DexignZone</a></span>
					</div>
				</div>
            </div>
		</div>
		<img src="assets/images/background/pic5.png" alt="" class="bg1 bottom-[10px] left-0 absolute max-2xl:hidden animate-dz">
		<img src="assets/images/background/pic6.png" alt="" class="top-[15px] right-[10px] absolute max-2xl:hidden animate-dz">
	</section>
	<!-- Footer End -->
	...
	<script src="assets/js/custom.min.js"></script> <!-- CUSTOM.MIN.JS -->
